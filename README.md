...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 993 | 🐛 7 | 🌐 Python | 📅 2026-08-24 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 12 | 🌐 Python | 📅 2026-08-22 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,400 | 🐛 48 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,556 | 🐛 8 | 🌐 Python | 📅 2026-08-24 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,936 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,153 | 🐛 22 | 🌐 Python | 📅 2026-08-24 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,952 | 🐛 14 | 🌐 Python | 📅 2026-08-24 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 960 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 2 | 🌐 Python | 📅 2026-08-24 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
