...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,007 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 72 | 🌐 Python | 📅 2026-09-25 - is behavior-driven development, Python style.
* [lettuce](https://github.com/gabrielfalcao/lettuce) ⭐ 1,275 | 🐛 101 | 🌐 Python | 📅 2020-12-29 - Behavior-driven-development tool for python, inspired by Cucumber for Ruby.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,409 | 🐛 317 | 🌐 Python | 📅 2026-09-23 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 845 | 🐛 52 | 🌐 Python | 📅 2026-09-25 - Automatically find diff lines that need test coverage.
* [slipcover](https://github.com/plasma-umass/slipcover) ⭐ 586 | 🐛 5 | 🌐 Python | 📅 2026-08-14 - Near Zero-Overhead Python Code Coverage.
...
* [deal](https://github.com/life4/deal) ⭐ 915 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [icontract](https://github.com/Parquery/icontract) ⭐ 416 | 🐛 2 | 🌐 Python | 📅 2026-01-29 - Design-by-contract in Python3 with informative violation messages and inheritance.

## Fake Data

* [faker](https://github.com/joke2k/faker) ⭐ 19,410 | 🐛 34 | 🌐 Python | 📅 2026-09-15 - A Python package that generates fake data.
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,839 | 🐛 16 | 🌐 Python | 📅 2026-09-23 - A Python library that helps you generate fake data.
* [fake2db](https://github.com/emirozer/fake2db) ⭐ 2,346 | 🐛 7 | 🌐 Python | 📅 2019-11-25 - Fake database generator.
* [autofaker](https://github.com/christianhelle/autofaker) ⭐ 8 | 🐛 8 | 🌐 Python | 📅 2026-09-17 - designed to minimize the setup/arrange phase of your unit tests by removing the need to manually write code to create anonymous variables as part of a test cases setup/arrange phase.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 57 | 🐛 10 | 🌐 Python | 📅 2026-09-25 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 9 | 🌐 Python | 📅 2026-09-25 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [OrcaReplay](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 265 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - Records a Python agent's calls to its model provider from outside the process, then serves the recording back so the same run happens again with the provider unreachable and no key. Turns a failed session into a regression test. Apache-2.0.
...
* [agent-convergence-scorer](https://github.com/hermes-labs-ai/agent-convergence-scorer) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A CLI and Python library that scores how lexically similar N agent or LLM outputs are: exact-match rate, Jaccard token overlap, divergence point, and a composite convergence score over any list of runs. An eval primitive for measuring reproducibility and fan-out collapse. Zero deps.
* [Sabot](https://github.com/Jott2121/sabot) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Plants controlled faults inside running multi-agent pipelines (LangGraph, CrewAI, AutoGen) and scores whether each pipeline's own reviewer and guardrail stages detect them. Pre-registered spec, deterministic adjudication, published raw traces.

## Load Testing

* [Locust](https://github.com/locustio/locust) ⭐ 28,182 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Scalable user load testing tool written in Python.
...
* [pynonymizer](https://github.com/jerometwell/pynonymizer) ⭐ 118 | 🐛 6 | 🌐 Python | 📅 2026-05-07 - is a universal tool for translating sensitive production database dumps into anonymized copies.
...
* [pywrkr](https://github.com/kurok/pywrkr) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - HTTP benchmarking CLI inspired by wrk and ApacheBench (ab), with latency percentiles, virtual-user simulation, constant-rate and traffic-profile load shaping, HAR import, and pass/fail SLO thresholds for CI.
...
* [Pympler](https://github.com/pympler/pympler) ⭐ 1,412 | 🐛 72 | 🌐 Python | 📅 2025-06-07 - is a development tool to measure, monitor and analyze the memory behavior of Python objects in a running Python application.
* [filprofiler](https://github.com/pythonspeed/filprofiler) ⭐ 908 | 🐛 106 | 🌐 Rust | 📅 2026-05-03 - A Python memory profiler for data processing and scientific computing applications.
* [Guppy 3](https://github.com/zhuyifei1999/guppy3) ⭐ 432 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - a Python programming environment & heap analysis toolset.
* [mem\_top](https://github.com/denis-ryzhkov/mem_top) ⭐ 81 | 🐛 0 | 🌐 Python | 📅 2022-07-13 - shows top suspects for memory leaks in your Python program.
* [tracemalloc](https://docs.python.org/3/library/tracemalloc.html) - is a debug tool to trace memory blocks allocated by Python.

## Mock and Stub

* [moto](https://github.com/spulec/moto) ⭐ 8,675 | 🐛 68 | 🌐 Python | 📅 2026-09-24 - allows you to easily mock out tests based on AWS infrastructure.
...
* [httpretty](https://github.com/gabrielfalcao/HTTPretty) ⭐ 2,155 | 🐛 130 | 🌐 Python | 📅 2024-06-09 - HTTP request mock tool for Python.
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 1,006 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 14 | 🌐 Python | 📅 2026-09-22 - A fake file system that mocks the Python file system modules.
* [trustme](https://github.com/python-trio/trustme) ⭐ 608 | 🐛 7 | 🌐 Python | 📅 2026-09-01 - gives you a fake certificate authority (CA) that you can use to generate fake TLS certs to use in your tests.
* [Aioresponses](https://github.com/pnuckowski/aioresponses) ⭐ 557 | 🐛 66 | 🌐 Python | 📅 2026-06-23 - is a helper for mock/fake web requests in python aiohttp package.
...
* [mocket](https://github.com/mindflayer/python-mocket) ⭐ 311 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - A socket mock framework with gevent/asyncio/SSL support.
...
* [Flexmock](https://github.com/flexmock/flexmock) ⭐ 65 | 🐛 27 | 🌐 Python | 📅 2026-09-05 - is a testing library for Python that makes it easy to create mocks, stubs and fakes.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,453 | 🐛 58 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 658 | 🐛 53 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
* [MutPy](https://github.com/mutpy/mutpy) ⭐ 368 | 🐛 36 | 🌐 Python | 📅 2024-04-23 - MutPy is a mutation testing tool for Python 3.x source code
* [Mutatest](https://github.com/EvanKepner/mutatest) ⭐ 102 | 🐛 7 | 🌐 Python | 📅 2023-02-17 - Python mutation testing.
...
* [greencheck](https://github.com/simin-yuan/greencheck) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Mutation testing aimed at the checker instead of the code: it mutates a known-good input and reports which mutations a validator, linter or CI quality gate fails to reject. Zero dependencies; on PyPI as `greencheck`.
* [Crucible](https://github.com/Jott2121/crucible) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Adversarial test-hardening for AI-written code, built on mutmut. A Tester agent writes tests, mutation testing names the survivors, and a Critic agent kills exactly those.

## Object Factories

* [factory\_boy](https://github.com/FactoryBoy/factory_boy) ⭐ 3,808 | 🐛 211 | 🌐 Python | 📅 2026-01-01 - A test fixtures replacement for Python.
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,511 | 🐛 76 | 🌐 Python | 📅 2026-09-18 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,004 | 🐛 9 | 🌐 Python | 📅 2026-09-22 - offers you a smart way to create fixtures for testing in Django.
...
* [python-pentest-tools](https://github.com/dloss/python-pentest-tools) ⭐ 2,887 | 🐛 2 | 📅 2026-07-22 - Python tools for penetration testers.
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,836 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 9,010 | 🐛 46 | 🌐 Python | 📅 2026-09-25 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,680 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [hypothesis-crosshair](https://github.com/pschanely/hypothesis-crosshair) ⭐ 28 | 🐛 7 | 🌐 Python | 📅 2026-09-09 - Add the power of solver-based symbolic execution to your Hypothesis tests with CrossHair.

## Reporting

* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,625 | 🐛 11 | 🌐 Python | 📅 2026-09-25 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,948 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,162 | 🐛 22 | 🌐 Python | 📅 2026-09-25 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
* [playback](https://github.com/Optibus/playback) ⭐ 107 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - A Python decorator-based framework that lets you "record" and "replay" operations (e.g. API requests, workers consuming jobs from queues).
...
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Hypothesis strategies for GraphQL schemas, queries and data.
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 19 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.
* [DriftWire](https://github.com/Haswell119/driftwire) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Detect API contract drift: validate a live API against its OpenAPI spec, or diff two spec versions for breaking changes.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 478 | 🐛 38 | 🌐 Python | 📅 2026-09-24 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
* [pytest-check](https://github.com/okken/pytest-check) ⭐ 427 | 🐛 5 | 🌐 Python | 📅 2026-08-01 - A pytest plugin that allows multiple failed assertions per test function, so you can see the whole picture of what's going wrong.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,015 | 🐛 172 | 🌐 Python | 📅 2026-09-15 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 889 | 🐛 6 | 🌐 Python | 📅 2026-09-25 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 754 | 🐛 24 | 🌐 Python | 📅 2026-09-25 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 212 | 🐛 15 | 🌐 Python | 📅 2026-08-28 - work by comparing the test results to a golden master.

## Speed

* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,015 | 🐛 39 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,788 | 🐛 2,186 | 🌐 Rust | 📅 2026-09-25 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,283 | 🐛 258 | 🌐 Python | 📅 2026-09-21 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,726 | 🐛 1,022 | 🌐 Python | 📅 2026-09-25 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,158 | 🐛 151 | 🌐 Rust | 📅 2026-09-25 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,461 | 🐛 59 | 🌐 Python | 📅 2026-09-22 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 863 | 🐛 14 | 🌐 Rust | 📅 2026-09-25 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 11 | 🌐 Python | 📅 2026-09-21 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,560 | 🐛 72 | 🌐 Python | 📅 2026-09-22 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,914 | 🐛 308 | 🌐 Python | 📅 2026-09-21 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,546 | 🐛 193 | 🌐 Python | 📅 2026-09-01 - A pytest plugin for Django applications.
...
* [nose2](https://github.com/nose-devs/nose2) ⭐ 827 | 🐛 45 | 🌐 Python | 📅 2026-09-14 - The successor to `nose`, based on `unittest2`.
* [maelstrom](https://github.com/maelstrom-software/maelstrom) ⭐ 735 | 🐛 189 | 🌐 Rust | 📅 2026-09-25 - Maelstrom is a fast Rust and Python test runner that runs every test in its own container. Tests are either run locally or distributed to a clustered job runner.
...
* [testbook](https://github.com/nteract/testbook) ⭐ 435 | 🐛 46 | 🌐 Python | 📅 2024-08-25 - A unit testing framework extension for testing code in Jupyter Notebooks.
* [xdoctest](https://github.com/Erotemic/xdoctest) ⭐ 221 | 🐛 28 | 🌐 Python | 📅 2026-09-08 - A rewrite of Python's builtin doctest module (with pytest plugin integration) with AST instead of REGEX.
...
* [vedro](https://github.com/vedro-universe/vedro) ⭐ 47 | 🐛 22 | 🌐 Python | 📅 2026-07-24 - Pragmatic testing framework for Python
...
* [tryke](https://github.com/thejchap/tryke) ⭐ 41 | 🐛 20 | 🌐 Rust | 📅 2026-09-01 - A Rust-based Python test runner with a Jest-style API
* [rut](https://github.com/schettino72/rut) ⭐ 13 | 🐛 3 | 🌐 Python | 📅 2026-07-30 - A modern and fully-featured test runner for Python's unittest framework (not `pytest`), with simplicity as a core design goal.
...
* [Sphinx-testify](https://github.com/BasicWolf/sphinx-testify) ⭐ 9 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Testified documentation means that the documentation source references test results, and these references are verified during the build process. As a result, we can keep every paragraph even every sentence of the documentation aligned with the code, as long as there is a test that "testifies" the described behaviour.
* [pytest-conversational](https://github.com/golikovichev/pytest-conversational) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - A pytest plugin for testing rule-based chatbots and conversational UIs through multi-turn dialogue assertions, with no LLM dependency.
* [mdoctest](https://github.com/ingrid-owusu/mdoctest) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - Doctest for Markdown in any language: runs the console sessions and code blocks in your README/docs, verifies their output still matches, and rewrites them in place with `--fix`. Zero dependencies; ships as a pre-commit hook and a GitHub Action.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,387 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,333 | 🐛 80 | 🌐 Python | 📅 2026-09-24 - An analysis tool for Python that blurs the line between testing and type systems.
* [Klara](https://github.com/usagitoneko97/klara) ⭐ 266 | 🐛 3 | 🌐 Python | 📅 2022-03-28 - Static analysis tools to automatic generate test case, based on SMT (z3) solver, with a powerful ast level inference system.
...
* [pytestify](https://github.com/dannysepler/pytestify) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-08-31 - Automatically convert unittests to pytest.
...
* [secure-log2test](https://github.com/golikovichev/secure-log2test) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - A CLI tool that converts Kibana JSON log exports into runnable pytest regression suites, with Pydantic-based redaction of authorization headers and other secrets at parse time.
* [csv-quality-gate](https://github.com/hermes-labs-ai/csv-quality-gate) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - A Python CLI that checks CSV test datasets and pipeline inputs for missing columns, empty cells, and duplicate rows, with configurable rules and CI exit codes.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,035 | 🐛 14 | 🌐 Python | 📅 2026-09-25 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,711 | 🐛 583 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,319 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
* [splinter](https://github.com/cobrateam/splinter) ⭐ 2,749 | 🐛 59 | 🌐 Python | 📅 2025-08-16 - Open source tool for testing web applications.
...
* [Flybirds](https://github.com/ctripcorp/flybirds) ⭐ 916 | 🐛 35 | 🌐 Python | 📅 2025-08-27 - is a front-end UI automation test framework based on BDD mode, providing a series of out-of-the-box tools and complete documentation.
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 887 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
* [selene](https://github.com/yashaka/selene) ⭐ 732 | 🐛 124 | 🌐 Python | 📅 2026-09-09 - User-oriented Web UI browser tests in Python (Selenide port).
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [9lives](https://github.com/Quality-Max/9lives) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Self-healing CLI for UI tests: runs a failing pytest + Selenium spec, repairs the drifted locator offline, re-runs it, and shows a diff before applying. Refuses to rewrite assertions, so real regressions stay visible.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 323,000 | 🐛 20 | 🌐 Python | 📅 2026-09-25 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,168 | 🐛 140 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 575 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 473 | 🐛 2 | 📅 2026-09-25 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 74 | 🐛 5 | 🌐 Python | 📅 2026-09-25 - Check commit message formatting, branch naming, commit author, email, and more.
