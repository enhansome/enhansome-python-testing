...
* [icontract](https://github.com/Parquery/icontract) ⭐ 414 | 🐛 2 | 🌐 Python | 📅 2026-01-29 - Design-by-contract in Python3 with informative violation messages and inheritance.

## Fake Data

* [faker](https://github.com/joke2k/faker) ⭐ 19,402 | 🐛 25 | 🌐 Python | 📅 2026-09-15 - A Python package that generates fake data.
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,842 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - A Python library that helps you generate fake data.
* [fake2db](https://github.com/emirozer/fake2db) ⭐ 2,347 | 🐛 7 | 🌐 Python | 📅 2019-11-25 - Fake database generator.
* [autofaker](https://github.com/christianhelle/autofaker) ⭐ 8 | 🐛 9 | 🌐 Python | 📅 2026-09-15 - designed to minimize the setup/arrange phase of your unit tests by removing the need to manually write code to create anonymous variables as part of a test cases setup/arrange phase.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-15 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
...
* [httpretty](https://github.com/gabrielfalcao/HTTPretty) ⭐ 2,156 | 🐛 130 | 🌐 Python | 📅 2024-06-09 - HTTP request mock tool for Python.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,439 | 🐛 56 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,969 | 🐛 43 | 🌐 Python | 📅 2026-09-14 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,600 | 🐛 7 | 🌐 Python | 📅 2026-09-15 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,942 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,160 | 🐛 24 | 🌐 Python | 📅 2026-09-11 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 474 | 🐛 37 | 🌐 Python | 📅 2026-09-15 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 882 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 752 | 🐛 24 | 🌐 Python | 📅 2026-09-15 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,639 | 🐛 2,191 | 🌐 Rust | 📅 2026-09-15 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,260 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,724 | 🐛 1,029 | 🌐 Python | 📅 2026-09-15 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,134 | 🐛 152 | 🌐 Rust | 📅 2026-09-15 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 851 | 🐛 16 | 🌐 Rust | 📅 2026-09-13 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,884 | 🐛 299 | 🌐 Python | 📅 2026-09-15 - A generic test automation framework.
...
* [vedro](https://github.com/vedro-universe/vedro) ⭐ 46 | 🐛 22 | 🌐 Python | 📅 2026-07-24 - Pragmatic testing framework for Python
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,386 | 🐛 3 | 🌐 Python | 📅 2026-09-15 - A tool that allows developers to generate unit tests automatically.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,014 | 🐛 14 | 🌐 Python | 📅 2026-09-15 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,697 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 910 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 320,855 | 🐛 18 | 🌐 Python | 📅 2026-09-15 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,161 | 🐛 138 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 575 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 472 | 🐛 2 | 📅 2026-09-04 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 5 | 🌐 Python | 📅 2026-09-15 - Check commit message formatting, branch naming, commit author, email, and more.
