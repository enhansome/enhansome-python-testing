...
* [behave](https://github.com/behave/behave) ⭐ 3,523 | 🐛 84 | 🌐 Python | 📅 2026-08-14 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 304 | 🌐 Python | 📅 2026-08-09 - is a tool for measuring code coverage of Python programs.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 17 | 🌐 Python | 📅 2026-08-12 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 17 | 🌐 Python | 📅 2026-08-10 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,613 | 🐛 56 | 🌐 Python | 📅 2026-08-11 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 992 | 🐛 7 | 🌐 Python | 📅 2026-08-12 - Travel through time in your tests.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,391 | 🐛 48 | 🌐 Python | 📅 2026-08-09 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 648 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,501 | 🐛 75 | 🌐 Python | 📅 2026-08-04 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,888 | 🐛 48 | 🌐 Python | 📅 2026-08-14 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,660 | 🐛 39 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [hypofuzz](https://github.com/Zac-HD/hypofuzz) ⭐ 122 | 🐛 30 | 🌐 Python | 📅 2026-05-15 - Adaptive fuzzing of Hypothesis tests.
...
* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 3 | 🌐 Python | 📅 2026-08-13 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,292 | 🐛 501 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,526 | 🐛 9 | 🌐 Python | 📅 2026-08-14 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,153 | 🐛 23 | 🌐 Python | 📅 2026-08-05 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 470 | 🐛 44 | 🌐 Python | 📅 2026-08-14 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,982 | 🐛 157 | 🌐 Python | 📅 2026-08-11 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 872 | 🐛 18 | 🌐 Python | 📅 2026-08-14 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,005 | 🐛 36 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,193 | 🐛 2,092 | 🌐 Rust | 📅 2026-08-14 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,216 | 🐛 258 | 🌐 Python | 📅 2026-08-04 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,712 | 🐛 1,087 | 🌐 Python | 📅 2026-08-13 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,086 | 🐛 151 | 🌐 Rust | 📅 2026-08-07 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 761 | 🐛 10 | 🌐 Python | 📅 2026-08-12 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,551 | 🐛 69 | 🌐 Python | 📅 2026-08-12 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 806 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,821 | 🐛 301 | 🌐 Python | 📅 2026-08-14 - A generic test automation framework.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,925 | 🐛 13 | 🌐 Python | 📅 2026-08-14 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,659 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 313,972 | 🐛 26 | 🌐 Python | 📅 2026-08-05 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,130 | 🐛 126 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 70 | 🐛 4 | 🌐 Python | 📅 2026-08-13 - Check commit message formatting, branch naming, commit author, email, and more.
