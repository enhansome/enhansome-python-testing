...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,411 | 🐛 305 | 🌐 Python | 📅 2026-08-31 - is a tool for measuring code coverage of Python programs.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 16 | 🌐 Python | 📅 2026-09-04 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 23 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,645 | 🐛 79 | 🌐 Python | 📅 2026-09-02 - allows you to easily mock out tests based on AWS infrastructure.
...
* [Flexmock](https://github.com/flexmock/flexmock) ⭐ 65 | 🐛 30 | 🌐 Python | 📅 2026-09-03 - is a testing library for Python that makes it easy to create mocks, stubs and fakes.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,423 | 🐛 54 | 🌐 Python | 📅 2026-09-03 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,822 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,581 | 🐛 11 | 🌐 Python | 📅 2026-09-04 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 473 | 🐛 40 | 🌐 Python | 📅 2026-09-04 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,000 | 🐛 164 | 🌐 Python | 📅 2026-09-01 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 879 | 🐛 7 | 🌐 Python | 📅 2026-09-03 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 211 | 🐛 14 | 🌐 Python | 📅 2026-08-28 - work by comparing the test results to a golden master.

## Speed

* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,011 | 🐛 37 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,480 | 🐛 2,167 | 🌐 Rust | 📅 2026-09-04 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,720 | 🐛 1,090 | 🌐 Python | 📅 2026-09-03 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,121 | 🐛 154 | 🌐 Rust | 📅 2026-09-01 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,321 | 🐛 78 | 🌐 Python | 📅 2026-09-01 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,982 | 🐛 14 | 🌐 Python | 📅 2026-09-03 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 318,269 | 🐛 17 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,151 | 🐛 135 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-09-04 - Check commit message formatting, branch naming, commit author, email, and more.
