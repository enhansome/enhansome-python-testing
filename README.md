...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,006 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 72 | 🌐 Python | 📅 2026-09-24 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,409 | 🐛 314 | 🌐 Python | 📅 2026-09-23 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 843 | 🐛 54 | 🌐 Python | 📅 2026-09-24 - Automatically find diff lines that need test coverage.
...
* [icontract](https://github.com/Parquery/icontract) ⭐ 415 | 🐛 2 | 🌐 Python | 📅 2026-01-29 - Design-by-contract in Python3 with informative violation messages and inheritance.

## Fake Data

* [faker](https://github.com/joke2k/faker) ⭐ 19,411 | 🐛 33 | 🌐 Python | 📅 2026-09-15 - A Python package that generates fake data.
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,840 | 🐛 16 | 🌐 Python | 📅 2026-09-23 - A Python library that helps you generate fake data.
* [fake2db](https://github.com/emirozer/fake2db) ⭐ 2,345 | 🐛 7 | 🌐 Python | 📅 2019-11-25 - Fake database generator.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 57 | 🐛 10 | 🌐 Python | 📅 2026-09-24 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 13 | 🌐 Python | 📅 2026-09-24 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,180 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Scalable user load testing tool written in Python.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,672 | 🐛 66 | 🌐 Python | 📅 2026-09-24 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 1,004 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Travel through time in your tests.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,451 | 🐛 58 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Crucible](https://github.com/Jott2121/crucible) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - Adversarial test-hardening for AI-written code, built on mutmut. A Tester agent writes tests, mutation testing names the survivors, and a Critic agent kills exactly those.

## Object Factories

* [factory\_boy](https://github.com/FactoryBoy/factory_boy) ⭐ 3,808 | 🐛 211 | 🌐 Python | 📅 2026-01-01 - A test fixtures replacement for Python.
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,510 | 🐛 76 | 🌐 Python | 📅 2026-09-18 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [python-pentest-tools](https://github.com/dloss/python-pentest-tools) ⭐ 2,886 | 🐛 2 | 📅 2026-07-22 - Python tools for penetration testers.
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,834 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 9,009 | 🐛 44 | 🌐 Python | 📅 2026-09-23 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,679 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,296 | 🐛 503 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,624 | 🐛 13 | 🌐 Python | 📅 2026-09-24 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,161 | 🐛 28 | 🌐 Python | 📅 2026-09-18 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 477 | 🐛 38 | 🌐 Python | 📅 2026-09-24 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 888 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 754 | 🐛 24 | 🌐 Python | 📅 2026-09-16 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,774 | 🐛 2,190 | 🌐 Rust | 📅 2026-09-24 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,281 | 🐛 258 | 🌐 Python | 📅 2026-09-21 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,726 | 🐛 1,025 | 🌐 Python | 📅 2026-09-24 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,154 | 🐛 152 | 🌐 Rust | 📅 2026-09-19 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [awesome-flake8-extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions) ⭐ 1,281 | 🐛 1 | 📅 2026-07-21 - A curated list of awesome flake8 extensions.
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 863 | 🐛 13 | 🌐 Rust | 📅 2026-09-23 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,560 | 🐛 71 | 🌐 Python | 📅 2026-09-22 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,914 | 🐛 307 | 🌐 Python | 📅 2026-09-21 - A generic test automation framework.
...
* [maelstrom](https://github.com/maelstrom-software/maelstrom) ⭐ 735 | 🐛 190 | 🌐 Rust | 📅 2025-04-23 - Maelstrom is a fast Rust and Python test runner that runs every test in its own container. Tests are either run locally or distributed to a clustered job runner.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,387 | 🐛 4 | 🌐 Python | 📅 2026-09-24 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,331 | 🐛 79 | 🌐 Python | 📅 2026-09-24 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [csv-quality-gate](https://github.com/hermes-labs-ai/csv-quality-gate) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A Python CLI that checks CSV test datasets and pipeline inputs for missing columns, empty cells, and duplicate rows, with configurable rules and CI exit codes.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,031 | 🐛 14 | 🌐 Python | 📅 2026-09-22 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,710 | 🐛 583 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,318 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
...
* [9lives](https://github.com/Quality-Max/9lives) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Self-healing CLI for UI tests: runs a failing pytest + Selenium spec, repairs the drifted locator offline, re-runs it, and shows a diff before applying. Refuses to rewrite assertions, so real regressions stay visible.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 322,772 | 🐛 21 | 🌐 Python | 📅 2026-09-23 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 473 | 🐛 2 | 📅 2026-09-23 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 74 | 🐛 5 | 🌐 Python | 📅 2026-09-24 - Check commit message formatting, branch naming, commit author, email, and more.
