...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-14 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,153 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Scalable user load testing tool written in Python.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,658 | 🐛 59 | 🌐 Python | 📅 2026-09-14 - allows you to easily mock out tests based on AWS infrastructure.
...
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 14 | 🌐 Python | 📅 2026-09-14 - A fake file system that mocks the Python file system modules.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,966 | 🐛 43 | 🌐 Python | 📅 2026-09-14 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,599 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,629 | 🐛 2,202 | 🌐 Rust | 📅 2026-09-14 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,029 | 🌐 Python | 📅 2026-09-14 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,134 | 🐛 152 | 🌐 Rust | 📅 2026-09-12 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 848 | 🐛 16 | 🌐 Rust | 📅 2026-09-13 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,882 | 🐛 299 | 🌐 Python | 📅 2026-09-14 - A generic test automation framework.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,386 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,327 | 🐛 78 | 🌐 Python | 📅 2026-09-09 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,016 | 🐛 15 | 🌐 Python | 📅 2026-09-14 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,696 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 908 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 320,644 | 🐛 18 | 🌐 Python | 📅 2026-09-13 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,158 | 🐛 138 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 5 | 🌐 Python | 📅 2026-09-13 - Check commit message formatting, branch naming, commit author, email, and more.
