...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 307 | 🌐 Python | 📅 2026-08-25 - is a tool for measuring code coverage of Python programs.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,627 | 🐛 62 | 🌐 Python | 📅 2026-08-25 - allows you to easily mock out tests based on AWS infrastructure.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,406 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,913 | 🐛 49 | 🌐 Python | 📅 2026-08-25 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,665 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,564 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,342 | 🐛 2,155 | 🌐 Rust | 📅 2026-08-26 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,717 | 🐛 1,078 | 🌐 Python | 📅 2026-08-26 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,113 | 🐛 155 | 🌐 Rust | 📅 2026-08-20 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 809 | 🐛 9 | 🌐 Rust | 📅 2026-08-26 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,844 | 🐛 298 | 🌐 Python | 📅 2026-08-26 - A generic test automation framework.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,954 | 🐛 14 | 🌐 Python | 📅 2026-08-26 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 316,247 | 🐛 15 | 🌐 Python | 📅 2026-08-25 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,146 | 🐛 132 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 574 | 🐛 4 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 470 | 🐛 3 | 📅 2026-08-06 - Mutation testing resources: how to make better code by introducing bugs
