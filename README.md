...
* [behave](https://github.com/behave/behave) ⭐ 3,527 | 🐛 77 | 🌐 Python | 📅 2026-09-03 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,411 | 🐛 307 | 🌐 Python | 📅 2026-09-06 - is a tool for measuring code coverage of Python programs.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,838 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - A Python library that helps you generate fake data.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-07 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 25 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [pywrkr](https://github.com/kurok/pywrkr) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - HTTP benchmarking CLI inspired by wrk and ApacheBench (ab), with latency percentiles, virtual-user simulation, constant-rate and traffic-profile load shaping, HAR import, and pass/fail SLO thresholds for CI.
...
* [Guppy 3](https://github.com/zhuyifei1999/guppy3) ⭐ 431 | 🐛 5 | 🌐 Python | 📅 2026-09-04 - a Python programming environment & heap analysis toolset.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,651 | 🐛 72 | 🌐 Python | 📅 2026-09-07 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 996 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 14 | 🌐 Python | 📅 2026-09-07 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,427 | 🐛 52 | 🌐 Python | 📅 2026-09-07 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 13 | 🌐 Python | 📅 2026-09-02 - offers you a smart way to create fixtures for testing in Django.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,825 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,945 | 🐛 45 | 🌐 Python | 📅 2026-09-06 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,585 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 474 | 🐛 44 | 🌐 Python | 📅 2026-09-04 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
* [pytest-check](https://github.com/okken/pytest-check) ⭐ 427 | 🐛 3 | 🌐 Python | 📅 2026-08-01 - A pytest plugin that allows multiple failed assertions per test function, so you can see the whole picture of what's going wrong.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,006 | 🐛 168 | 🌐 Python | 📅 2026-09-01 - Record and replay HTTP interactions on your tests.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,537 | 🐛 2,175 | 🌐 Rust | 📅 2026-09-07 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,082 | 🌐 Python | 📅 2026-09-06 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,126 | 🐛 154 | 🌐 Rust | 📅 2026-09-01 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 840 | 🐛 9 | 🌐 Rust | 📅 2026-09-07 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,554 | 🐛 75 | 🌐 Python | 📅 2026-09-03 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,870 | 🐛 300 | 🌐 Python | 📅 2026-09-04 - A generic test automation framework.
...
* [xdoctest](https://github.com/Erotemic/xdoctest) ⭐ 221 | 🐛 28 | 🌐 Python | 📅 2026-07-14 - A rewrite of Python's builtin doctest module (with pytest plugin integration) with AST instead of REGEX.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,383 | 🐛 8 | 🌐 Python | 📅 2026-09-03 - A tool that allows developers to generate unit tests automatically.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,990 | 🐛 14 | 🌐 Python | 📅 2026-09-03 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,681 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [splinter](https://github.com/cobrateam/splinter) ⭐ 2,752 | 🐛 58 | 🌐 Python | 📅 2025-08-16 - Open source tool for testing web applications.
...
* [HMNextAuto](https://github.com/ziguiway/hmnextauto) ⭐ 17 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Python-based UI automation framework for HarmonyOS NEXT. API compatible with uiautomator2, supports XPath, image recognition, performance monitoring and notification management.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 319,120 | 🐛 19 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,152 | 🐛 135 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
