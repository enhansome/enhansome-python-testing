...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 73 | 🌐 Python | 📅 2026-09-21 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,410 | 🐛 307 | 🌐 Python | 📅 2026-09-21 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 843 | 🐛 54 | 🌐 Python | 📅 2026-09-21 - Automatically find diff lines that need test coverage.
...
* [pact-python](https://github.com/pact-foundation/pact-python) ⭐ 684 | 🐛 19 | 🌐 Python | 📅 2026-09-21 - Python version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,841 | 🐛 16 | 🌐 Python | 📅 2026-09-18 - A Python library that helps you generate fake data.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 57 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,666 | 🐛 64 | 🌐 Python | 📅 2026-09-21 - allows you to easily mock out tests based on AWS infrastructure.
...
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 14 | 🌐 Python | 📅 2026-09-21 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,446 | 🐛 57 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,003 | 🐛 11 | 🌐 Python | 📅 2026-09-21 - offers you a smart way to create fixtures for testing in Django.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,999 | 🐛 44 | 🌐 Python | 📅 2026-09-20 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,617 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 886 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,720 | 🐛 2,196 | 🌐 Rust | 📅 2026-09-21 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,277 | 🐛 258 | 🌐 Python | 📅 2026-09-21 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,725 | 🐛 1,035 | 🌐 Python | 📅 2026-09-21 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,146 | 🐛 151 | 🌐 Rust | 📅 2026-09-19 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,459 | 🐛 60 | 🌐 Python | 📅 2026-09-21 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 858 | 🐛 14 | 🌐 Rust | 📅 2026-09-21 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,560 | 🐛 74 | 🌐 Python | 📅 2026-09-21 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,907 | 🐛 301 | 🌐 Python | 📅 2026-09-21 - A generic test automation framework.
...
* [mdoctest](https://github.com/ingrid-owusu/mdoctest) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Doctest for Markdown in any language: runs the console sessions and code blocks in your README/docs, verifies their output still matches, and rewrites them in place with `--fix`. Zero dependencies; ships as a pre-commit hook and a GitHub Action.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,387 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,330 | 🐛 76 | 🌐 Python | 📅 2026-09-15 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,030 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,703 | 🐛 583 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 322,148 | 🐛 21 | 🌐 Python | 📅 2026-09-20 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 473 | 🐛 3 | 📅 2026-09-17 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 74 | 🐛 7 | 🌐 Python | 📅 2026-09-16 - Check commit message formatting, branch naming, commit author, email, and more.
