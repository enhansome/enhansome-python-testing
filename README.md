...
* [behave](https://github.com/behave/behave) ⭐ 3,524 | 🐛 77 | 🌐 Python | 📅 2026-08-29 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,409 | 🐛 305 | 🌐 Python | 📅 2026-08-31 - is a tool for measuring code coverage of Python programs.
...
* [deal](https://github.com/life4/deal) ⭐ 906 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [faker](https://github.com/joke2k/faker) ⭐ 19,384 | 🐛 30 | 🌐 Python | 📅 2026-08-31 - A Python package that generates fake data.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 20 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,637 | 🐛 63 | 🌐 Python | 📅 2026-08-28 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 994 | 🐛 7 | 🌐 Python | 📅 2026-08-28 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 13 | 🌐 Python | 📅 2026-08-31 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,412 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,504 | 🐛 74 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 13 | 🌐 Python | 📅 2026-08-24 - offers you a smart way to create fixtures for testing in Django.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,820 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,927 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,669 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [hypothesis-crosshair](https://github.com/pschanely/hypothesis-crosshair) ⭐ 27 | 🐛 6 | 🌐 Python | 📅 2026-08-22 - Add the power of solver-based symbolic execution to your Hypothesis tests with CrossHair.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,573 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,939 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
* [cherrybomb](https://github.com/blst-security/cherrybomb) ⭐ 1,235 | 🐛 38 | 🌐 Rust | 📅 2024-10-25 - CLI tool that helps you avoid undefined user behaviour by auditing your API specifications, validating them and running API security tests.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,988 | 🐛 161 | 🌐 Python | 📅 2026-08-25 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 879 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,008 | 🐛 37 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,413 | 🐛 2,164 | 🌐 Rust | 📅 2026-08-31 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,082 | 🌐 Python | 📅 2026-08-31 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,117 | 🐛 156 | 🌐 Rust | 📅 2026-08-28 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,457 | 🐛 60 | 🌐 Python | 📅 2025-06-20 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 824 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,852 | 🐛 301 | 🌐 Python | 📅 2026-08-31 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,546 | 🐛 188 | 🌐 Python | 📅 2026-08-10 - A pytest plugin for Django applications.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,319 | 🐛 78 | 🌐 Python | 📅 2026-08-31 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,973 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,672 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 896 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [9lives](https://github.com/Quality-Max/9lives) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Self-healing CLI for UI tests: runs a failing pytest + Selenium spec, repairs the drifted locator offline, re-runs it, and shows a diff before applying. Refuses to rewrite assertions, so real regressions stay visible.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 317,411 | 🐛 18 | 🌐 Python | 📅 2026-08-25 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,147 | 🐛 135 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 575 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 470 | 🐛 2 | 📅 2026-08-27 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - Check commit message formatting, branch naming, commit author, email, and more.
