...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,004 | 🐛 25 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [sure](https://github.com/gabrielfalcao/sure) ⭐ 699 | 🐛 25 | 🌐 Python | 📅 2025-03-01 - An idiomatic assertion toolkit with human-friendly failure messages, inspired by RSpec Expectations and should.js.
...
* [behave](https://github.com/behave/behave) ⭐ 3,524 | 🐛 78 | 🌐 Python | 📅 2026-08-17 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,408 | 🐛 307 | 🌐 Python | 📅 2026-08-19 - is a tool for measuring code coverage of Python programs.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,839 | 🐛 14 | 🌐 Python | 📅 2026-08-18 - A Python library that helps you generate fake data.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 21 | 🌐 Python | 📅 2026-08-18 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 21 | 🌐 Python | 📅 2026-08-18 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [pywrkr](https://github.com/kurok/pywrkr) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - HTTP benchmarking CLI inspired by wrk and ApacheBench (ab), with latency percentiles, virtual-user simulation, constant-rate and traffic-profile load shaping, HAR import, and pass/fail SLO thresholds for CI.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,620 | 🐛 62 | 🌐 Python | 📅 2026-08-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 993 | 🐛 7 | 🌐 Python | 📅 2026-08-18 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 16 | 🌐 Python | 📅 2026-08-17 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,394 | 🐛 47 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 651 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,502 | 🐛 72 | 🌐 Python | 📅 2026-08-19 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,813 | 🐛 21 | 🌐 Python | 📅 2026-08-17 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,897 | 🐛 45 | 🌐 Python | 📅 2026-08-16 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,662 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,293 | 🐛 502 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,539 | 🐛 9 | 🌐 Python | 📅 2026-08-19 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,153 | 🐛 24 | 🌐 Python | 📅 2026-08-05 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 39 | 🌐 Python | 📅 2026-08-18 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,981 | 🐛 158 | 🌐 Python | 📅 2026-08-18 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 873 | 🐛 19 | 🌐 Python | 📅 2026-08-18 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [pytest-picked](https://github.com/anapaulagomes/pytest-picked) ⭐ 410 | 🐛 8 | 🌐 Python | 📅 2026-07-01 - Run only tests from modified test files, or run tests from modified test files first, followed by all unmodified tests
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,250 | 🐛 2,114 | 🌐 Rust | 📅 2026-08-19 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,712 | 🐛 1,080 | 🌐 Python | 📅 2026-08-19 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,101 | 🐛 153 | 🌐 Rust | 📅 2026-08-07 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 786 | 🐛 12 | 🌐 Python | 📅 2026-08-12 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
* [pyanalyze](https://github.com/quora/pyanalyze) ⭐ 387 | 🐛 61 | 🌐 Python | 📅 2026-01-27 - A tool for programmatically detecting common mistakes in Python code, such as references to undefined variables and some categories of type mismatches.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,552 | 🐛 69 | 🌐 Python | 📅 2026-08-18 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 806 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,825 | 🐛 300 | 🌐 Python | 📅 2026-08-19 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,544 | 🐛 187 | 🌐 Python | 📅 2026-08-10 - A pytest plugin for Django applications.
...
* [pytest-conversational](https://github.com/golikovichev/pytest-conversational) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - A pytest plugin for testing rule-based chatbots and conversational UIs through multi-turn dialogue assertions, with no LLM dependency.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,315 | 🐛 76 | 🌐 Python | 📅 2026-08-18 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [secure-log2test](https://github.com/golikovichev/secure-log2test) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - A CLI tool that converts Kibana JSON log exports into runnable pytest regression suites, with Pydantic-based redaction of authorization headers and other secrets at parse time.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,934 | 🐛 14 | 🌐 Python | 📅 2026-08-19 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,665 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,325 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 314,856 | 🐛 18 | 🌐 Python | 📅 2026-08-16 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-08-19 - Check commit message formatting, branch naming, commit author, email, and more.
