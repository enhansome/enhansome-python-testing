...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,005 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 79 | 🌐 Python | 📅 2026-09-17 - is behavior-driven development, Python style.
...
* [deal](https://github.com/life4/deal) ⭐ 914 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
* [pact-python](https://github.com/pact-foundation/pact-python) ⭐ 684 | 🐛 16 | 🌐 Python | 📅 2026-09-18 - Python version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,843 | 🐛 16 | 🌐 Python | 📅 2026-09-18 - A Python library that helps you generate fake data.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-18 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,663 | 🐛 60 | 🌐 Python | 📅 2026-09-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 1,001 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Travel through time in your tests.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,443 | 🐛 57 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [gatecheck](https://github.com/simin-yuan/self-auditing-agent/tree/main/gatecheck) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-17 - Mutation testing aimed at the checker instead of the code: it mutates a known-good input and reports which mutations a validator, linter or CI quality gate fails to reject. Stdlib only.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,508 | 🐛 76 | 🌐 Python | 📅 2026-09-18 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,003 | 🐛 11 | 🌐 Python | 📅 2026-09-14 - offers you a smart way to create fixtures for testing in Django.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,833 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,984 | 🐛 44 | 🌐 Python | 📅 2026-09-14 - is an advanced Quickcheck style property based testing library.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,298 | 🐛 503 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,609 | 🐛 10 | 🌐 Python | 📅 2026-09-18 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,945 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,161 | 🐛 27 | 🌐 Python | 📅 2026-09-18 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 19 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 477 | 🐛 42 | 🌐 Python | 📅 2026-09-18 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,010 | 🐛 172 | 🌐 Python | 📅 2026-09-15 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 884 | 🐛 8 | 🌐 Python | 📅 2026-09-18 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,016 | 🐛 39 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,688 | 🐛 2,178 | 🌐 Rust | 📅 2026-09-18 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,725 | 🐛 1,034 | 🌐 Python | 📅 2026-09-15 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,138 | 🐛 151 | 🌐 Rust | 📅 2026-09-18 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [awesome-flake8-extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions) ⭐ 1,280 | 🐛 1 | 📅 2026-07-21 - A curated list of awesome flake8 extensions.
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 855 | 🐛 15 | 🌐 Rust | 📅 2026-09-18 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 11 | 🌐 Python | 📅 2026-09-17 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,560 | 🐛 75 | 🌐 Python | 📅 2026-09-14 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,899 | 🐛 299 | 🌐 Python | 📅 2026-09-18 - A generic test automation framework.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,387 | 🐛 2 | 🌐 Python | 📅 2026-09-18 - A tool that allows developers to generate unit tests automatically.
...
* [pytest-databases](https://github.com/litestar-org/pytest-databases) ⭐ 59 | 🐛 20 | 🌐 Python | 📅 2026-09-17 - Reusable database fixtures for any and all databases.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,025 | 🐛 14 | 🌐 Python | 📅 2026-09-18 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,703 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 884 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 321,540 | 🐛 24 | 🌐 Python | 📅 2026-09-15 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,167 | 🐛 140 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 575 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 473 | 🐛 2 | 📅 2026-09-17 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 73 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Check commit message formatting, branch naming, commit author, email, and more.
