...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,005 | 🐛 25 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [behave](https://github.com/behave/behave) ⭐ 3,525 | 🐛 78 | 🌐 Python | 📅 2026-08-17 - is behavior-driven development, Python style.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,898 | 🐛 45 | 🌐 Python | 📅 2026-08-16 - is an advanced Quickcheck style property based testing library.
...
* [playback](https://github.com/Optibus/playback) ⭐ 107 | 🐛 4 | 🌐 Python | 📅 2026-08-19 - A Python decorator-based framework that lets you "record" and "replay" operations (e.g. API requests, workers consuming jobs from queues).
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 40 | 🌐 Python | 📅 2026-08-18 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,256 | 🐛 2,116 | 🌐 Rust | 📅 2026-08-19 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,712 | 🐛 1,083 | 🌐 Python | 📅 2026-08-19 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 787 | 🐛 12 | 🌐 Python | 📅 2026-08-12 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,826 | 🐛 300 | 🌐 Python | 📅 2026-08-19 - A generic test automation framework.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,316 | 🐛 76 | 🌐 Python | 📅 2026-08-19 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,936 | 🐛 13 | 🌐 Python | 📅 2026-08-19 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,324 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 314,930 | 🐛 18 | 🌐 Python | 📅 2026-08-16 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,135 | 🐛 127 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
