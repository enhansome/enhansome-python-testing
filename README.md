...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,406 | 🐛 307 | 🌐 Python | 📅 2026-08-23 - is a tool for measuring code coverage of Python programs.
...
* [icontract](https://github.com/Parquery/icontract) ⭐ 412 | 🐛 2 | 🌐 Python | 📅 2026-01-29 - Design-by-contract in Python3 with informative violation messages and inheritance.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,622 | 🐛 60 | 🌐 Python | 📅 2026-08-22 - allows you to easily mock out tests based on AWS infrastructure.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,399 | 🐛 48 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 14 | 🌐 Python | 📅 2026-08-22 - offers you a smart way to create fixtures for testing in Django.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,909 | 🐛 46 | 🌐 Python | 📅 2026-08-23 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,554 | 🐛 9 | 🌐 Python | 📅 2026-08-23 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,153 | 🐛 21 | 🌐 Python | 📅 2026-08-23 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 875 | 🐛 6 | 🌐 Python | 📅 2026-08-22 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,008 | 🐛 36 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,288 | 🐛 2,142 | 🌐 Rust | 📅 2026-08-23 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,233 | 🐛 259 | 🌐 Python | 📅 2026-08-04 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,714 | 🐛 1,100 | 🌐 Python | 📅 2026-08-23 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 795 | 🐛 12 | 🌐 Rust | 📅 2026-08-23 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,841 | 🐛 299 | 🌐 Python | 📅 2026-08-21 - A generic test automation framework.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,947 | 🐛 14 | 🌐 Python | 📅 2026-08-19 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 955 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 2 | 🌐 Python | 📅 2026-08-23 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 315,669 | 🐛 16 | 🌐 Python | 📅 2026-08-23 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,142 | 🐛 128 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
