...
* [behave](https://github.com/behave/behave) ⭐ 3,525 | 🐛 77 | 🌐 Python | 📅 2026-09-02 - is behavior-driven development, Python style.
...
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 842 | 🐛 67 | 🌐 Python | 📅 2026-09-01 - Automatically find diff lines that need test coverage.
...
* [deal](https://github.com/life4/deal) ⭐ 908 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 23 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,640 | 🐛 74 | 🌐 Python | 📅 2026-09-02 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 994 | 🐛 8 | 🌐 Python | 📅 2026-08-28 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 12 | 🌐 Python | 📅 2026-09-01 - A fake file system that mocks the Python file system modules.
* [trustme](https://github.com/python-trio/trustme) ⭐ 606 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - gives you a fake certificate authority (CA) that you can use to generate fake TLS certs to use in your tests.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,417 | 🐛 51 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 655 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,503 | 🐛 74 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,933 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - is an advanced Quickcheck style property based testing library.
...
* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 5 | 🌐 Python | 📅 2026-08-30 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,577 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,940 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,154 | 🐛 23 | 🌐 Python | 📅 2026-08-31 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 43 | 🌐 Python | 📅 2026-09-01 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,995 | 🐛 163 | 🌐 Python | 📅 2026-09-01 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 879 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 210 | 🐛 14 | 🌐 Python | 📅 2026-08-28 - work by comparing the test results to a golden master.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,449 | 🐛 2,164 | 🌐 Rust | 📅 2026-09-02 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,083 | 🌐 Python | 📅 2026-09-01 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,118 | 🐛 154 | 🌐 Rust | 📅 2026-09-01 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 828 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 14 | 🌐 Python | 📅 2026-09-02 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,554 | 🐛 74 | 🌐 Python | 📅 2026-09-02 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 805 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,861 | 🐛 301 | 🌐 Python | 📅 2026-09-02 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,546 | 🐛 191 | 🌐 Python | 📅 2026-09-01 - A pytest plugin for Django applications.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,383 | 🐛 8 | 🌐 Python | 📅 2026-08-27 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,320 | 🐛 78 | 🌐 Python | 📅 2026-09-01 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [pytest-databases](https://github.com/litestar-org/pytest-databases) ⭐ 58 | 🐛 17 | 🌐 Python | 📅 2026-07-22 - Reusable database fixtures for any and all databases.
...
* [ttsproof](https://github.com/Mormolykos/ttsproof) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - Automated failure-mode QA for text-to-speech systems. Structural audio checks, equivalence-aware WER/CER, and ASR-uncertainty quarantine so transcription noise is not reported as a synthesis defect.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,973 | 🐛 14 | 🌐 Python | 📅 2026-09-02 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,673 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 899 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
* [selene](https://github.com/yashaka/selene) ⭐ 732 | 🐛 123 | 🌐 Python | 📅 2026-08-09 - User-oriented Web UI browser tests in Python (Selenide port).
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 317,764 | 🐛 16 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,149 | 🐛 135 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 576 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 471 | 🐛 2 | 📅 2026-08-27 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-09-01 - Check commit message formatting, branch naming, commit author, email, and more.
