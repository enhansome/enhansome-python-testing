...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,003 | 🐛 28 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [behave](https://github.com/behave/behave) ⭐ 3,527 | 🐛 77 | 🌐 Python | 📅 2026-09-08 - is behavior-driven development, Python style.
...
* [deal](https://github.com/life4/deal) ⭐ 909 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,839 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - A Python library that helps you generate fake data.
...
* [pytest-deadfixtures](https://github.com/jllorencetti/pytest-deadfixtures) ⭐ 165 | 🐛 17 | 🌐 Python | 📅 2026-01-15 - A simple plugin to list unused or duplicated fixtures in a pytest suite.
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-08 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,652 | 🐛 72 | 🌐 Python | 📅 2026-09-08 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 996 | 🐛 9 | 🌐 Python | 📅 2026-09-08 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 15 | 🌐 Python | 📅 2026-09-08 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,427 | 🐛 58 | 🌐 Python | 📅 2026-09-08 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 656 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,503 | 🐛 75 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,826 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,950 | 🐛 40 | 🌐 Python | 📅 2026-09-08 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,674 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [hypothesis-crosshair](https://github.com/pschanely/hypothesis-crosshair) ⭐ 28 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - Add the power of solver-based symbolic execution to your Hypothesis tests with CrossHair.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,587 | 🐛 11 | 🌐 Python | 📅 2026-09-08 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,156 | 🐛 27 | 🌐 Python | 📅 2026-09-04 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 474 | 🐛 41 | 🌐 Python | 📅 2026-09-08 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,006 | 🐛 168 | 🌐 Python | 📅 2026-09-08 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 880 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 751 | 🐛 24 | 🌐 Python | 📅 2026-09-07 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,012 | 🐛 38 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,551 | 🐛 2,182 | 🌐 Rust | 📅 2026-09-08 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,083 | 🌐 Python | 📅 2026-09-08 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 842 | 🐛 9 | 🌐 Rust | 📅 2026-09-07 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,555 | 🐛 76 | 🌐 Python | 📅 2026-09-03 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,872 | 🐛 300 | 🌐 Python | 📅 2026-09-04 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,546 | 🐛 192 | 🌐 Python | 📅 2026-09-01 - A pytest plugin for Django applications.
...
* [nose2](https://github.com/nose-devs/nose2) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-09-07 - The successor to `nose`, based on `unittest2`.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,384 | 🐛 9 | 🌐 Python | 📅 2026-09-08 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,323 | 🐛 78 | 🌐 Python | 📅 2026-09-01 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,993 | 🐛 14 | 🌐 Python | 📅 2026-09-03 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,683 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [splinter](https://github.com/cobrateam/splinter) ⭐ 2,752 | 🐛 59 | 🌐 Python | 📅 2025-08-16 - Open source tool for testing web applications.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 904 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
* [selene](https://github.com/yashaka/selene) ⭐ 732 | 🐛 124 | 🌐 Python | 📅 2026-09-03 - User-oriented Web UI browser tests in Python (Selenide port).
...
* [HMNextAuto](https://github.com/ziguiway/hmnextauto) ⭐ 18 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Python-based UI automation framework for HarmonyOS NEXT. API compatible with uiautomator2, supports XPath, image recognition, performance monitoring and notification management.
...
* [9lives](https://github.com/Quality-Max/9lives) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Self-healing CLI for UI tests: runs a failing pytest + Selenium spec, repairs the drifted locator offline, re-runs it, and shows a diff before applying. Refuses to rewrite assertions, so real regressions stay visible.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 319,357 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,153 | 🐛 135 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 576 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 471 | 🐛 2 | 📅 2026-09-04 - Mutation testing resources: how to make better code by introducing bugs
