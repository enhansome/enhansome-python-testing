...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,410 | 🐛 309 | 🌐 Python | 📅 2026-09-20 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 843 | 🐛 55 | 🌐 Python | 📅 2026-09-20 - Automatically find diff lines that need test coverage.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,665 | 🐛 67 | 🌐 Python | 📅 2026-09-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,445 | 🐛 57 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,997 | 🐛 44 | 🌐 Python | 📅 2026-09-20 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,613 | 🐛 9 | 🌐 Python | 📅 2026-09-20 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 2 | 🌐 Python | 📅 2026-09-20 - Hypothesis strategies for GraphQL schemas, queries and data.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 885 | 🐛 8 | 🌐 Python | 📅 2026-09-20 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,706 | 🐛 2,195 | 🌐 Rust | 📅 2026-09-20 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,725 | 🐛 1,034 | 🌐 Python | 📅 2026-09-20 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,145 | 🐛 151 | 🌐 Rust | 📅 2026-09-19 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,903 | 🐛 302 | 🌐 Python | 📅 2026-09-18 - A generic test automation framework.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,329 | 🐛 76 | 🌐 Python | 📅 2026-09-15 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 321,940 | 🐛 19 | 🌐 Python | 📅 2026-09-20 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 74 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Check commit message formatting, branch naming, commit author, email, and more.
