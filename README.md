...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 307 | 🌐 Python | 📅 2026-08-26 - is a tool for measuring code coverage of Python programs.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,914 | 🐛 50 | 🌐 Python | 📅 2026-08-25 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,666 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 41 | 🌐 Python | 📅 2026-08-27 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,984 | 🐛 161 | 🌐 Python | 📅 2026-08-25 - Record and replay HTTP interactions on your tests.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,351 | 🐛 2,158 | 🌐 Rust | 📅 2026-08-27 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,718 | 🐛 1,075 | 🌐 Python | 📅 2026-08-27 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 815 | 🐛 10 | 🌐 Rust | 📅 2026-08-26 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,958 | 🐛 14 | 🌐 Python | 📅 2026-08-26 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 847 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 316,381 | 🐛 15 | 🌐 Python | 📅 2026-08-25 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,147 | 🐛 133 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
