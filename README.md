...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 83 | 🌐 Python | 📅 2026-09-19 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,410 | 🐛 308 | 🌐 Python | 📅 2026-09-13 - is a tool for measuring code coverage of Python programs.
...
* [faker](https://github.com/joke2k/faker) ⭐ 19,403 | 🐛 26 | 🌐 Python | 📅 2026-09-15 - A Python package that generates fake data.
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,842 | 🐛 16 | 🌐 Python | 📅 2026-09-18 - A Python library that helps you generate fake data.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,664 | 🐛 61 | 🌐 Python | 📅 2026-09-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,444 | 🐛 57 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,003 | 🐛 13 | 🌐 Python | 📅 2026-09-19 - offers you a smart way to create fixtures for testing in Django.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,988 | 🐛 44 | 🌐 Python | 📅 2026-09-14 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,611 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 885 | 🐛 8 | 🌐 Python | 📅 2026-09-19 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,696 | 🐛 2,181 | 🌐 Rust | 📅 2026-09-19 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,275 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - is a tool designed to find common security issues in Python code.
...
* [typos](https://github.com/crate-ci/typos) ⭐ 4,142 | 🐛 150 | 🌐 Rust | 📅 2026-09-19 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,459 | 🐛 60 | 🌐 Python | 📅 2026-09-02 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 855 | 🐛 14 | 🌐 Rust | 📅 2026-09-19 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,560 | 🐛 78 | 🌐 Python | 📅 2026-09-19 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,902 | 🐛 299 | 🌐 Python | 📅 2026-09-18 - A generic test automation framework.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,328 | 🐛 76 | 🌐 Python | 📅 2026-09-15 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,027 | 🐛 15 | 🌐 Python | 📅 2026-09-18 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,704 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 886 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 321,735 | 🐛 26 | 🌐 Python | 📅 2026-09-18 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,169 | 🐛 140 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
