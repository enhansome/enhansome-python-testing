...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,004 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 78 | 🌐 Python | 📅 2026-09-15 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,412 | 🐛 306 | 🌐 Python | 📅 2026-09-13 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 843 | 🐛 61 | 🌐 Python | 📅 2026-09-07 - Automatically find diff lines that need test coverage.
...
* [deal](https://github.com/life4/deal) ⭐ 912 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
* [pact-python](https://github.com/pact-foundation/pact-python) ⭐ 683 | 🐛 17 | 🌐 Python | 📅 2026-09-16 - Python version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,843 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - A Python library that helps you generate fake data.
* [fake2db](https://github.com/emirozer/fake2db) ⭐ 2,347 | 🐛 7 | 🌐 Python | 📅 2019-11-25 - Fake database generator.
* [autofaker](https://github.com/christianhelle/autofaker) ⭐ 8 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - designed to minimize the setup/arrange phase of your unit tests by removing the need to manually write code to create anonymous variables as part of a test cases setup/arrange phase.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-16 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 26 | 🌐 Python | 📅 2026-09-14 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,162 | 🐛 5 | 🌐 Python | 📅 2026-09-15 - Scalable user load testing tool written in Python.
...
* [pywrkr](https://github.com/kurok/pywrkr) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - HTTP benchmarking CLI inspired by wrk and ApacheBench (ab), with latency percentiles, virtual-user simulation, constant-rate and traffic-profile load shaping, HAR import, and pass/fail SLO thresholds for CI.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,661 | 🐛 58 | 🌐 Python | 📅 2026-09-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 999 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 13 | 🌐 Python | 📅 2026-09-15 - A fake file system that mocks the Python file system modules.
* [trustme](https://github.com/python-trio/trustme) ⭐ 607 | 🐛 7 | 🌐 Python | 📅 2026-09-01 - gives you a fake certificate authority (CA) that you can use to generate fake TLS certs to use in your tests.
...
* [Pretend](https://github.com/alex/pretend) ⭐ 317 | 🐛 4 | 🌐 Python | 📅 2024-06-22 - is a library to make stubbing with Python easier.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,442 | 🐛 57 | 🌐 Python | 📅 2026-09-12 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 658 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [gatecheck](https://github.com/simin-yuan/self-auditing-agent/tree/main/gatecheck) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-16 - Mutation testing aimed at the checker instead of the code: it mutates a known-good input and reports which mutations a validator, linter or CI quality gate fails to reject. Stdlib only.
* [Crucible](https://github.com/Jott2121/crucible) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Adversarial test-hardening for AI-written code, built on mutmut. A Tester agent writes tests, mutation testing names the survivors, and a Critic agent kills exactly those.

## Object Factories

* [factory\_boy](https://github.com/FactoryBoy/factory_boy) ⭐ 3,806 | 🐛 211 | 🌐 Python | 📅 2026-01-01 - A test fixtures replacement for Python.
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,506 | 🐛 75 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 11 | 🌐 Python | 📅 2026-09-14 - offers you a smart way to create fixtures for testing in Django.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,832 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,977 | 🐛 43 | 🌐 Python | 📅 2026-09-14 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,678 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,604 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,943 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
* [cherrybomb](https://github.com/blst-security/cherrybomb) ⭐ 1,236 | 🐛 38 | 🌐 Rust | 📅 2024-10-25 - CLI tool that helps you avoid undefined user behaviour by auditing your API specifications, validating them and running API security tests.
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,161 | 🐛 24 | 🌐 Python | 📅 2026-09-11 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - Hypothesis strategies for GraphQL schemas, queries and data.
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 475 | 🐛 36 | 🌐 Python | 📅 2026-09-16 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
* [pytest-check](https://github.com/okken/pytest-check) ⭐ 427 | 🐛 4 | 🌐 Python | 📅 2026-08-01 - A pytest plugin that allows multiple failed assertions per test function, so you can see the whole picture of what's going wrong.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,009 | 🐛 169 | 🌐 Python | 📅 2026-09-15 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 883 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 752 | 🐛 24 | 🌐 Python | 📅 2026-09-16 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,015 | 🐛 38 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,647 | 🐛 2,187 | 🌐 Rust | 📅 2026-09-16 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,268 | 🐛 258 | 🌐 Python | 📅 2026-08-29 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,724 | 🐛 1,031 | 🌐 Python | 📅 2026-09-15 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,135 | 🐛 152 | 🌐 Rust | 📅 2026-09-15 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,459 | 🐛 59 | 🌐 Python | 📅 2026-09-02 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 852 | 🐛 16 | 🌐 Rust | 📅 2026-09-13 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 11 | 🌐 Python | 📅 2026-09-14 - Find mistakes in your `__slots__` definitions.
* [Typecheckers](https://github.com/ethanhs/python-typecheckers) ⭐ 75 | 🐛 1 | 📅 2026-03-19 - A list of Python type checkers.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,559 | 🐛 76 | 🌐 Python | 📅 2026-09-14 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,888 | 🐛 300 | 🌐 Python | 📅 2026-09-15 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,547 | 🐛 193 | 🌐 Python | 📅 2026-09-01 - A pytest plugin for Django applications.
...
* [testbook](https://github.com/nteract/testbook) ⭐ 433 | 🐛 46 | 🌐 Python | 📅 2024-08-25 - A unit testing framework extension for testing code in Jupyter Notebooks.
...
* [hammett](https://github.com/boxed/hammett) ⭐ 96 | 🐛 7 | 🌐 Python | 📅 2024-09-23 - Fast python test runner, compatible with a subset of pytest.
...
* [Sphinx-testify](https://github.com/BasicWolf/sphinx-testify) ⭐ 9 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Testified documentation means that the documentation source references test results, and these references are verified during the build process. As a result, we can keep every paragraph even every sentence of the documentation aligned with the code, as long as there is a test that "testifies" the described behaviour.
* [pytest-conversational](https://github.com/golikovichev/pytest-conversational) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - A pytest plugin for testing rule-based chatbots and conversational UIs through multi-turn dialogue assertions, with no LLM dependency.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,386 | 🐛 3 | 🌐 Python | 📅 2026-09-16 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,328 | 🐛 75 | 🌐 Python | 📅 2026-09-15 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [pytest-databases](https://github.com/litestar-org/pytest-databases) ⭐ 59 | 🐛 19 | 🌐 Python | 📅 2026-07-22 - Reusable database fixtures for any and all databases.
...
* [secure-log2test](https://github.com/golikovichev/secure-log2test) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - A CLI tool that converts Kibana JSON log exports into runnable pytest regression suites, with Pydantic-based redaction of authorization headers and other secrets at parse time.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,019 | 🐛 15 | 🌐 Python | 📅 2026-09-16 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,698 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,320 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 911 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [HMNextAuto](https://github.com/ziguiway/hmnextauto) ⭐ 21 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Python-based UI automation framework for HarmonyOS NEXT. API compatible with uiautomator2, supports XPath, image recognition, performance monitoring and notification management.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 321,088 | 🐛 19 | 🌐 Python | 📅 2026-09-15 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,163 | 🐛 140 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 575 | 🐛 5 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 473 | 🐛 3 | 📅 2026-09-04 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Check commit message formatting, branch naming, commit author, email, and more.
