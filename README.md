...
* [behave](https://github.com/behave/behave) ⭐ 3,527 | 🐛 77 | 🌐 Python | 📅 2026-09-09 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,412 | 🐛 306 | 🌐 Python | 📅 2026-09-07 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 842 | 🐛 61 | 🌐 Python | 📅 2026-09-07 - Automatically find diff lines that need test coverage.
...
* [deal](https://github.com/life4/deal) ⭐ 910 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,840 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - A Python library that helps you generate fake data.
...
* [pytest-deadfixtures](https://github.com/jllorencetti/pytest-deadfixtures) ⭐ 164 | 🐛 17 | 🌐 Python | 📅 2026-01-15 - A simple plugin to list unused or duplicated fixtures in a pytest suite.
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-10 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 27 | 🌐 Python | 📅 2026-09-07 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [pywrkr](https://github.com/kurok/pywrkr) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - HTTP benchmarking CLI inspired by wrk and ApacheBench (ab), with latency percentiles, virtual-user simulation, constant-rate and traffic-profile load shaping, HAR import, and pass/fail SLO thresholds for CI.
...
* [Pympler](https://github.com/pympler/pympler) ⭐ 1,410 | 🐛 72 | 🌐 Python | 📅 2025-06-07 - is a development tool to measure, monitor and analyze the memory behavior of Python objects in a running Python application.
* [filprofiler](https://github.com/pythonspeed/filprofiler) ⭐ 907 | 🐛 105 | 🌐 Rust | 📅 2026-05-03 - A Python memory profiler for data processing and scientific computing applications.
* [Guppy 3](https://github.com/zhuyifei1999/guppy3) ⭐ 431 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - a Python programming environment & heap analysis toolset.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,653 | 🐛 73 | 🌐 Python | 📅 2026-09-09 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 996 | 🐛 7 | 🌐 Python | 📅 2026-09-08 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 13 | 🌐 Python | 📅 2026-09-09 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,433 | 🐛 60 | 🌐 Python | 📅 2026-09-09 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 657 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,504 | 🐛 75 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,003 | 🐛 11 | 🌐 Python | 📅 2026-09-08 - offers you a smart way to create fixtures for testing in Django.
...
* [python-pentest-tools](https://github.com/dloss/python-pentest-tools) ⭐ 2,884 | 🐛 2 | 📅 2026-07-22 - Python tools for penetration testers.
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,830 | 🐛 22 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,955 | 🐛 40 | 🌐 Python | 📅 2026-09-08 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,676 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,296 | 🐛 502 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,595 | 🐛 11 | 🌐 Python | 📅 2026-09-10 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,941 | 🐛 299 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,160 | 🐛 27 | 🌐 Python | 📅 2026-09-04 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - Hypothesis strategies for GraphQL schemas, queries and data.
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 474 | 🐛 41 | 🌐 Python | 📅 2026-09-09 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [pytest-leak-finder](https://github.com/mgaitan/pytest-leak-finder) ⭐ 41 | 🐛 4 | 🌐 Python | 📅 2025-12-19 - You have a test that passes when executed alone but fails when running its suite. What's happening? My two cents that some previous test keeps the things dirty. But which one/s, maybe the previous are a lot, right?
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,008 | 🐛 168 | 🌐 Python | 📅 2026-09-08 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 881 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 752 | 🐛 24 | 🌐 Python | 📅 2026-09-10 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 212 | 🐛 14 | 🌐 Python | 📅 2026-08-28 - work by comparing the test results to a golden master.

## Speed

* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,013 | 🐛 38 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,579 | 🐛 2,192 | 🌐 Rust | 📅 2026-09-10 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,257 | 🐛 259 | 🌐 Python | 📅 2026-08-29 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,085 | 🌐 Python | 📅 2026-09-08 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,125 | 🐛 154 | 🌐 Rust | 📅 2026-09-01 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,458 | 🐛 59 | 🌐 Python | 📅 2026-09-02 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 844 | 🐛 9 | 🌐 Rust | 📅 2026-09-07 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 11 | 🌐 Python | 📅 2026-09-07 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,557 | 🐛 78 | 🌐 Python | 📅 2026-09-03 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,878 | 🐛 301 | 🌐 Python | 📅 2026-09-09 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,547 | 🐛 192 | 🌐 Python | 📅 2026-09-01 - A pytest plugin for Django applications.
...
* [nose2](https://github.com/nose-devs/nose2) ⭐ 827 | 🐛 45 | 🌐 Python | 📅 2026-09-07 - The successor to `nose`, based on `unittest2`.
* [maelstrom](https://github.com/maelstrom-software/maelstrom) ⭐ 734 | 🐛 190 | 🌐 Rust | 📅 2025-04-23 - Maelstrom is a fast Rust and Python test runner that runs every test in its own container. Tests are either run locally or distributed to a clustered job runner.
...
* [tryke](https://github.com/thejchap/tryke) ⭐ 41 | 🐛 19 | 🌐 Rust | 📅 2026-09-01 - A Rust-based Python test runner with a Jest-style API
...
* [Sphinx-testify](https://github.com/BasicWolf/sphinx-testify) ⭐ 9 | 🐛 3 | 🌐 Python | 📅 2026-09-10 - Testified documentation means that the documentation source references test results, and these references are verified during the build process. As a result, we can keep every paragraph even every sentence of the documentation aligned with the code, as long as there is a test that "testifies" the described behaviour.
* [pytest-conversational](https://github.com/golikovichev/pytest-conversational) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - A pytest plugin for testing rule-based chatbots and conversational UIs through multi-turn dialogue assertions, with no LLM dependency.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,384 | 🐛 9 | 🌐 Python | 📅 2026-09-10 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,323 | 🐛 78 | 🌐 Python | 📅 2026-09-09 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [pytestify](https://github.com/dannysepler/pytestify) ⭐ 59 | 🐛 10 | 🌐 Python | 📅 2026-08-31 - Automatically convert unittests to pytest.
...
* [secure-log2test](https://github.com/golikovichev/secure-log2test) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - A CLI tool that converts Kibana JSON log exports into runnable pytest regression suites, with Pydantic-based redaction of authorization headers and other secrets at parse time.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,004 | 🐛 14 | 🌐 Python | 📅 2026-09-10 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,688 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,321 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 909 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [HMNextAuto](https://github.com/ziguiway/hmnextauto) ⭐ 20 | 🐛 2 | 🌐 Python | 📅 2026-08-26 - Python-based UI automation framework for HarmonyOS NEXT. API compatible with uiautomator2, supports XPath, image recognition, performance monitoring and notification management.
...
* [9lives](https://github.com/Quality-Max/9lives) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Self-healing CLI for UI tests: runs a failing pytest + Selenium spec, repairs the drifted locator offline, re-runs it, and shows a diff before applying. Refuses to rewrite assertions, so real regressions stay visible.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 319,784 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,156 | 🐛 137 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-09-07 - Check commit message formatting, branch naming, commit author, email, and more.
