...
* [behave](https://github.com/behave/behave) ⭐ 3,525 | 🐛 77 | 🌐 Python | 📅 2026-08-29 - is behavior-driven development, Python style.
...
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 841 | 🐛 67 | 🌐 Python | 📅 2026-09-01 - Automatically find diff lines that need test coverage.
...
* [deal](https://github.com/life4/deal) ⭐ 907 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,840 | 🐛 14 | 🌐 Python | 📅 2026-08-23 - A Python library that helps you generate fake data.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,637 | 🐛 72 | 🌐 Python | 📅 2026-09-01 - allows you to easily mock out tests based on AWS infrastructure.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,414 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 17 | 🌐 Python | 📅 2026-09-01 - offers you a smart way to create fixtures for testing in Django.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,821 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,932 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,672 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [hypothesis-crosshair](https://github.com/pschanely/hypothesis-crosshair) ⭐ 27 | 🐛 7 | 🌐 Python | 📅 2026-09-01 - Add the power of solver-based symbolic execution to your Hypothesis tests with CrossHair.

## Reporting

* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-08-30 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,577 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 42 | 🌐 Python | 📅 2026-09-01 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,990 | 🐛 163 | 🌐 Python | 📅 2026-09-01 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 879 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 750 | 🐛 24 | 🌐 Python | 📅 2026-08-14 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 210 | 🐛 13 | 🌐 Python | 📅 2026-08-28 - work by comparing the test results to a golden master.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,430 | 🐛 2,167 | 🌐 Rust | 📅 2026-09-01 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,081 | 🌐 Python | 📅 2026-09-01 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,117 | 🐛 154 | 🌐 Rust | 📅 2026-09-01 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,458 | 🐛 61 | 🌐 Python | 📅 2026-09-01 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 826 | 🐛 9 | 🌐 Rust | 📅 2026-08-31 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,554 | 🐛 74 | 🌐 Python | 📅 2026-09-01 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 805 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,853 | 🐛 300 | 🌐 Python | 📅 2026-09-01 - A generic test automation framework.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,319 | 🐛 78 | 🌐 Python | 📅 2026-09-01 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,972 | 🐛 14 | 🌐 Python | 📅 2026-09-01 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 897 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 317,773 | 🐛 16 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,150 | 🐛 135 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
