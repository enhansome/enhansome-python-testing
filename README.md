...
* [behave](https://github.com/behave/behave) ⭐ 3,523 | 🐛 80 | 🌐 Python | 📅 2026-08-15 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,408 | 🐛 306 | 🌐 Python | 📅 2026-08-09 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 842 | 🐛 63 | 🌐 Python | 📅 2026-08-08 - Automatically find diff lines that need test coverage.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,073 | 🐛 4 | 🌐 Python | 📅 2026-08-10 - Scalable user load testing tool written in Python.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,614 | 🐛 57 | 🌐 Python | 📅 2026-08-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [trustme](https://github.com/python-trio/trustme) ⭐ 605 | 🐛 5 | 🌐 Python | 📅 2026-08-05 - gives you a fake certificate authority (CA) that you can use to generate fake TLS certs to use in your tests.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,811 | 🐛 20 | 🌐 Python | 📅 2026-08-10 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,889 | 🐛 44 | 🌐 Python | 📅 2026-08-15 - is an advanced Quickcheck style property based testing library.
...
* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 2 | 🌐 Python | 📅 2026-08-15 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,292 | 🐛 502 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,529 | 🐛 9 | 🌐 Python | 📅 2026-08-14 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,934 | 🐛 298 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 470 | 🐛 45 | 🌐 Python | 📅 2026-08-14 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 872 | 🐛 18 | 🌐 Python | 📅 2026-08-15 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,213 | 🐛 2,098 | 🌐 Rust | 📅 2026-08-15 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,713 | 🐛 1,081 | 🌐 Python | 📅 2026-08-15 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,087 | 🐛 152 | 🌐 Rust | 📅 2026-08-07 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 772 | 🐛 10 | 🌐 Python | 📅 2026-08-12 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,552 | 🐛 68 | 🌐 Python | 📅 2026-08-12 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 806 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,821 | 🐛 303 | 🌐 Python | 📅 2026-08-14 - A generic test automation framework.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,315 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,926 | 🐛 13 | 🌐 Python | 📅 2026-08-14 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,660 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 314,132 | 🐛 27 | 🌐 Python | 📅 2026-08-05 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,131 | 🐛 126 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 70 | 🐛 4 | 🌐 Python | 📅 2026-08-15 - Check commit message formatting, branch naming, commit author, email, and more.
