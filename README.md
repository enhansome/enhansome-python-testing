...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,411 | 🐛 306 | 🌐 Python | 📅 2026-08-31 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 842 | 🐛 62 | 🌐 Python | 📅 2026-09-03 - Automatically find diff lines that need test coverage.
...
* [pact-python](https://github.com/pact-foundation/pact-python) ⭐ 682 | 🐛 24 | 🌐 Python | 📅 2026-09-05 - Python version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,838 | 🐛 14 | 🌐 Python | 📅 2026-08-23 - A Python library that helps you generate fake data.
...
* [pytest-deadfixtures](https://github.com/jllorencetti/pytest-deadfixtures) ⭐ 166 | 🐛 17 | 🌐 Python | 📅 2026-01-15 - A simple plugin to list unused or duplicated fixtures in a pytest suite.
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 14 | 🌐 Python | 📅 2026-09-05 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 24 | 🌐 Python | 📅 2026-08-31 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,128 | 🐛 5 | 🌐 Python | 📅 2026-08-26 - Scalable user load testing tool written in Python.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,647 | 🐛 76 | 🌐 Python | 📅 2026-09-05 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 996 | 🐛 8 | 🌐 Python | 📅 2026-08-28 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,424 | 🐛 53 | 🌐 Python | 📅 2026-09-05 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,502 | 🐛 75 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,824 | 🐛 21 | 🌐 Python | 📅 2026-08-31 - A Modular Penetration Testing Framework.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,939 | 🐛 44 | 🌐 Python | 📅 2026-08-31 - is an advanced Quickcheck style property based testing library.
...
* [hypothesis-crosshair](https://github.com/pschanely/hypothesis-crosshair) ⭐ 27 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - Add the power of solver-based symbolic execution to your Hypothesis tests with CrossHair.

## Reporting

* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 71 | 🐛 3 | 🌐 Python | 📅 2026-09-05 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,580 | 🐛 11 | 🌐 Python | 📅 2026-09-05 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,155 | 🐛 27 | 🌐 Python | 📅 2026-09-04 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 4 | 🌐 Python | 📅 2026-08-30 - Hypothesis strategies for GraphQL schemas, queries and data.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 473 | 🐛 41 | 🌐 Python | 📅 2026-09-04 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
* [pytest-check](https://github.com/okken/pytest-check) ⭐ 427 | 🐛 2 | 🌐 Python | 📅 2026-08-01 - A pytest plugin that allows multiple failed assertions per test function, so you can see the whole picture of what's going wrong.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,003 | 🐛 165 | 🌐 Python | 📅 2026-09-01 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 879 | 🐛 7 | 🌐 Python | 📅 2026-09-05 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 751 | 🐛 24 | 🌐 Python | 📅 2026-08-14 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,503 | 🐛 2,174 | 🌐 Rust | 📅 2026-09-05 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,722 | 🐛 1,091 | 🌐 Python | 📅 2026-09-03 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,122 | 🐛 154 | 🌐 Rust | 📅 2026-09-01 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [pyflakes](https://github.com/PyCQA/pyflakes) ⭐ 1,458 | 🐛 60 | 🌐 Python | 📅 2026-09-02 - A simple program which checks Python source files for errors.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 834 | 🐛 9 | 🌐 Rust | 📅 2026-09-03 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 14 | 🌐 Python | 📅 2026-09-03 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,554 | 🐛 74 | 🌐 Python | 📅 2026-09-03 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 804 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,867 | 🐛 300 | 🌐 Python | 📅 2026-09-04 - A generic test automation framework.
...
* [nose2](https://github.com/nose-devs/nose2) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-08-31 - The successor to `nose`, based on `unittest2`.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,322 | 🐛 78 | 🌐 Python | 📅 2026-09-01 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [pytest-databases](https://github.com/litestar-org/pytest-databases) ⭐ 58 | 🐛 18 | 🌐 Python | 📅 2026-07-22 - Reusable database fixtures for any and all databases.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,984 | 🐛 14 | 🌐 Python | 📅 2026-09-03 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,676 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2026-09-04 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 318,498 | 🐛 16 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 71 | 🐛 4 | 🌐 Python | 📅 2026-09-05 - Check commit message formatting, branch naming, commit author, email, and more.
