...
* [behave](https://github.com/behave/behave) ⭐ 3,529 | 🐛 78 | 🌐 Python | 📅 2026-09-17 - is behavior-driven development, Python style.
...
* [deal](https://github.com/life4/deal) ⭐ 913 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
* [pact-python](https://github.com/pact-foundation/pact-python) ⭐ 683 | 🐛 15 | 🌐 Python | 📅 2026-09-17 - Python version of Pact. Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-09-17 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,662 | 🐛 60 | 🌐 Python | 📅 2026-09-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 1,000 | 🐛 7 | 🌐 Python | 📅 2026-09-14 - Travel through time in your tests.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,508 | 🐛 75 | 🌐 Python | 📅 2026-08-24 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,978 | 🐛 43 | 🌐 Python | 📅 2026-09-14 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,608 | 🐛 9 | 🌐 Python | 📅 2026-09-17 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 476 | 🐛 44 | 🌐 Python | 📅 2026-09-17 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 3,009 | 🐛 170 | 🌐 Python | 📅 2026-09-15 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 884 | 🐛 7 | 🌐 Python | 📅 2026-09-17 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,669 | 🐛 2,164 | 🌐 Rust | 📅 2026-09-17 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,725 | 🐛 1,033 | 🌐 Python | 📅 2026-09-15 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,136 | 🐛 152 | 🌐 Rust | 📅 2026-09-15 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 855 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,896 | 🐛 300 | 🌐 Python | 📅 2026-09-15 - A generic test automation framework.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,387 | 🐛 2 | 🌐 Python | 📅 2026-09-17 - A tool that allows developers to generate unit tests automatically.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 13,023 | 🐛 14 | 🌐 Python | 📅 2026-09-17 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,699 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 913 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 321,315 | 🐛 21 | 🌐 Python | 📅 2026-09-15 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,166 | 🐛 140 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 72 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Check commit message formatting, branch naming, commit author, email, and more.
