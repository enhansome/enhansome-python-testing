...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,004 | 🐛 23 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [sure](https://github.com/gabrielfalcao/sure) ⭐ 699 | 🐛 24 | 🌐 Python | 📅 2025-03-01 - An idiomatic assertion toolkit with human-friendly failure messages, inspired by RSpec Expectations and should.js.
...
* [behave](https://github.com/behave/behave) ⭐ 3,523 | 🐛 83 | 🌐 Python | 📅 2026-08-12 - is behavior-driven development, Python style.
* [lettuce](https://github.com/gabrielfalcao/lettuce) ⭐ 1,277 | 🐛 101 | 🌐 Python | 📅 2020-12-29 - Behavior-driven-development tool for python, inspired by Cucumber for Ruby.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,407 | 🐛 303 | 🌐 Python | 📅 2026-08-09 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 842 | 🐛 62 | 🌐 Python | 📅 2026-08-08 - Automatically find diff lines that need test coverage.
...
* [deal](https://github.com/life4/deal) ⭐ 903 | 🐛 8 | 🌐 Python | 📅 2025-11-30 - Design by contract for Python with static checker and test generation.
...
* [icontract](https://github.com/Parquery/icontract) ⭐ 411 | 🐛 2 | 🌐 Python | 📅 2026-01-29 - Design-by-contract in Python3 with informative violation messages and inheritance.

## Fake Data

* [faker](https://github.com/joke2k/faker) ⭐ 19,369 | 🐛 30 | 🌐 Python | 📅 2026-08-03 - A Python package that generates fake data.
* [mimesis](https://github.com/lk-geimfari/mimesis) ⭐ 4,840 | 🐛 12 | 🌐 Python | 📅 2026-08-05 - A Python library that helps you generate fake data.
* [fake2db](https://github.com/emirozer/fake2db) ⭐ 2,349 | 🐛 7 | 🌐 Python | 📅 2019-11-25 - Fake database generator.
* [autofaker](https://github.com/christianhelle/autofaker) ⭐ 8 | 🐛 6 | 🌐 Python | 📅 2026-07-30 - designed to minimize the setup/arrange phase of your unit tests by removing the need to manually write code to create anonymous variables as part of a test cases setup/arrange phase.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 10 | 🌐 Python | 📅 2026-08-12 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 10 | 🌐 Python | 📅 2026-08-10 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [Tenro](https://github.com/tenro-ai/tenro-python) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-06-09 - An open-source, provider-agnostic testing framework for AI agents that integrates with pytest. It simulates LLM and tool calls to test edge cases, failure paths, and agent logic without live API calls.
...
* [Locust](https://github.com/locustio/locust) ⭐ 28,070 | 🐛 5 | 🌐 Python | 📅 2026-08-10 - Scalable user load testing tool written in Python.
...
* [Grizzly](https://github.com/biometria-se/grizzly) ⭐ 13 | 🐛 3 | 🌐 Python | 📅 2026-03-24 - is a framework to be able to easily define load scenarios, and is mainly built on-top of Locust and Behave.
...
* [pywrkr](https://github.com/kurok/pywrkr) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-07-31 - HTTP benchmarking CLI inspired by wrk and ApacheBench (ab), with latency percentiles, virtual-user simulation, constant-rate and traffic-profile load shaping, HAR import, and pass/fail SLO thresholds for CI.

## Memory Management

* [Pympler](https://github.com/pympler/pympler) ⭐ 1,408 | 🐛 70 | 🌐 Python | 📅 2025-06-07 - is a development tool to measure, monitor and analyze the memory behavior of Python objects in a running Python application.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,613 | 🐛 54 | 🌐 Python | 📅 2026-08-11 - allows you to easily mock out tests based on AWS infrastructure.
...
* [httpretty](https://github.com/gabrielfalcao/HTTPretty) ⭐ 2,165 | 🐛 130 | 🌐 Python | 📅 2024-06-09 - HTTP request mock tool for Python.
* [time-machine](https://github.com/adamchainz/time-machine) ⭐ 991 | 🐛 7 | 🌐 Python | 📅 2026-08-12 - Travel through time in your tests.
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 16 | 🌐 Python | 📅 2026-08-13 - A fake file system that mocks the Python file system modules.
* [trustme](https://github.com/python-trio/trustme) ⭐ 604 | 🐛 5 | 🌐 Python | 📅 2026-08-05 - gives you a fake certificate authority (CA) that you can use to generate fake TLS certs to use in your tests.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,389 | 🐛 46 | 🌐 Python | 📅 2026-08-09 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 647 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,500 | 🐛 75 | 🌐 Python | 📅 2026-08-04 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 12 | 🌐 Python | 📅 2026-08-09 - offers you a smart way to create fixtures for testing in Django.
...
* [python-pentest-tools](https://github.com/dloss/python-pentest-tools) ⭐ 2,882 | 🐛 2 | 📅 2026-07-22 - Python tools for penetration testers.
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,810 | 🐛 20 | 🌐 Python | 📅 2026-08-10 - A Modular Penetration Testing Framework.
* [fencer](https://github.com/abunuwas/fencer) ⭐ 87 | 🐛 4 | 🌐 Python | 📅 2024-08-02 - Fencer is an automated API security testing tool. It's an experimental project to see how much of the API security testing process can be automated.

## Property Based Testing

* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,883 | 🐛 52 | 🌐 Python | 📅 2026-08-12 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,659 | 🐛 39 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [hypofuzz](https://github.com/Zac-HD/hypofuzz) ⭐ 121 | 🐛 30 | 🌐 Python | 📅 2026-05-15 - Adaptive fuzzing of Hypothesis tests.
* [icontract-hypothesis](https://github.com/mristin/icontract-hypothesis) ⭐ 90 | 🐛 2 | 🌐 Python | 📅 2022-06-05 - Instead of writing manually the Hypothesis search strategies for a function, `icontract-hypothesis` infers them based on the function's precondition.
* [hypothesis-crosshair](https://github.com/pschanely/hypothesis-crosshair) ⭐ 27 | 🐛 5 | 🌐 Python | 📅 2026-07-25 - Add the power of solver-based symbolic execution to your Hypothesis tests with CrossHair.

## Reporting

* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 70 | 🐛 4 | 🌐 Python | 📅 2026-08-13 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [HttpRunner](https://github.com/httprunner/httprunner) ⭐ 4,295 | 🐛 501 | 🌐 Go | 📅 2025-12-11 - is a simple & elegant, yet powerful HTTP(S) testing framework.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,520 | 🐛 9 | 🌐 Python | 📅 2026-08-13 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
* [RESTler](https://github.com/microsoft/restler-fuzzer) ⭐ 2,933 | 🐛 298 | 🌐 Python | 📅 2026-06-10 - is the first stateful REST API fuzzing tool for automatically testing cloud services through their REST APIs and finding security and reliability bugs in these services.
* [cherrybomb](https://github.com/blst-security/cherrybomb) ⭐ 1,233 | 🐛 38 | 🌐 Rust | 📅 2024-10-25 - CLI tool that helps you avoid undefined user behaviour by auditing your API specifications, validating them and running API security tests.
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,151 | 🐛 23 | 🌐 Python | 📅 2026-08-05 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
* [playback](https://github.com/Optibus/playback) ⭐ 107 | 🐛 3 | 🌐 Python | 📅 2026-06-10 - A Python decorator-based framework that lets you "record" and "replay" operations (e.g. API requests, workers consuming jobs from queues).
* [behave-restful](https://github.com/behave-restful/behave-restful) ⭐ 67 | 🐛 4 | 🌐 Python | 📅 2026-07-19 - BDD Framework to Test REST Services and APIs.
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 4 | 🌐 Python | 📅 2026-08-10 - Hypothesis strategies for GraphQL schemas, queries and data.
* [postman2pytest](https://github.com/golikovichev/postman2pytest) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - A CLI tool to convert Postman Collection v2.1 JSON files into runnable pytest suites, supporting environment variable substitution, folder filtering, and stress-test generation.

## Retrying Tests

* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 470 | 🐛 42 | 🌐 Python | 📅 2026-08-13 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
* [pytest-check](https://github.com/okken/pytest-check) ⭐ 425 | 🐛 2 | 🌐 Python | 📅 2026-08-01 - A pytest plugin that allows multiple failed assertions per test function, so you can see the whole picture of what's going wrong.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,982 | 🐛 156 | 🌐 Python | 📅 2026-08-11 - Record and replay HTTP interactions on your tests.
* [syrupy](https://github.com/tophat/syrupy) ⭐ 872 | 🐛 18 | 🌐 Python | 📅 2026-08-10 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
* [inline-snapshot](https://github.com/15r10nk/inline-snapshot/) ⭐ 749 | 🐛 24 | 🌐 Python | 📅 2026-08-11 - a pytest plugin that boosts efficiency when writing tests by generating code with the expected values and simplifies snapshot tests with pytest.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 209 | 🐛 14 | 🌐 Python | 📅 2026-08-10 - work by comparing the test results to a golden master.

## Speed

* [pytest-testmon](https://github.com/tarpas/pytest-testmon) ⭐ 1,004 | 🐛 37 | 🌐 Python | 📅 2025-12-01 - Selects tests affected by changed files. Continuous test runner when used with pytest-watch.
* [pytest-picked](https://github.com/anapaulagomes/pytest-picked) ⭐ 408 | 🐛 8 | 🌐 Python | 📅 2026-07-01 - Run only tests from modified test files, or run tests from modified test files first, followed by all unmodified tests
...
* [Partial Testing](https://github.com/man-group/partialtesting) ⭐ 77 | 🐛 2 | 🌐 Python | 📅 2020-08-25 - Run only the tests that are relevant for your changes.
* [Pytest-incremental](https://github.com/pytest-dev/pytest-incremental) ⭐ 55 | 🐛 4 | 🌐 Python | 📅 2026-02-05 - analyses your project structure and file modifications between test-runs to modify the order tests are executed and de-select tests.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,187 | 🐛 2,103 | 🌐 Rust | 📅 2026-08-13 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,212 | 🐛 258 | 🌐 Python | 📅 2026-08-04 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,712 | 🐛 1,083 | 🌐 Python | 📅 2026-08-13 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,084 | 🐛 151 | 🌐 Rust | 📅 2026-08-07 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [awesome-flake8-extensions](https://github.com/DmytroLitvinov/awesome-flake8-extensions) ⭐ 1,279 | 🐛 1 | 📅 2026-07-21 - A curated list of awesome flake8 extensions.
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 749 | 🐛 10 | 🌐 Python | 📅 2026-08-12 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 12 | 🌐 Python | 📅 2026-08-11 - Find mistakes in your `__slots__` definitions.
...
* [Nox](https://github.com/theacodes/nox) ⭐ 1,549 | 🐛 69 | 🌐 Python | 📅 2026-08-12 - is a command-line tool that automates testing in multiple Python environments, similar to tox. Unlike tox, Nox uses a standard Python file for configuration.
* [green](https://github.com/CleanCut/green) ⭐ 806 | 🐛 8 | 🌐 Python | 📅 2024-11-12 - A clean, colorful test runner.
* [tox](https://tox.readthedocs.io/en/latest) - Auto builds and tests distributions in multiple Python versions.

## Testing Frameworks

* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,818 | 🐛 304 | 🌐 Python | 📅 2026-08-11 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,543 | 🐛 186 | 🌐 Python | 📅 2026-08-10 - A pytest plugin for Django applications.
...
* [nose2](https://github.com/nose-devs/nose2) ⭐ 826 | 🐛 45 | 🌐 Python | 📅 2026-08-10 - The successor to `nose`, based on `unittest2`.
...
* [xdoctest](https://github.com/Erotemic/xdoctest) ⭐ 223 | 🐛 28 | 🌐 Python | 📅 2026-07-14 - A rewrite of Python's builtin doctest module (with pytest plugin integration) with AST instead of REGEX.
...
* [perftester](https://github.com/nyggus/perftester) ⭐ 44 | 🐛 12 | 🌐 Python | 📅 2026-02-04 - A lightweight framework for performance testing of Python functions; allows for testing of performance in terms of execution time and memory usage.
* [tryke](https://github.com/thejchap/tryke) ⭐ 41 | 🐛 17 | 🌐 Rust | 📅 2026-08-01 - A Rust-based Python test runner with a Jest-style API
* [rut](https://github.com/schettino72/rut) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2026-07-30 - A modern and fully-featured test runner for Python's unittest framework (not `pytest`), with simplicity as a core design goal.
...
* [Sphinx-testify](https://github.com/BasicWolf/sphinx-testify) ⭐ 9 | 🐛 2 | 🌐 Python | 📅 2026-07-27 - Testified documentation means that the documentation source references test results, and these references are verified during the build process. As a result, we can keep every paragraph even every sentence of the documentation aligned with the code, as long as there is a test that "testifies" the described behaviour.
* [pytest-conversational](https://github.com/golikovichev/pytest-conversational) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - A pytest plugin for testing rule-based chatbots and conversational UIs through multi-turn dialogue assertions, with no LLM dependency.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,384 | 🐛 9 | 🌐 Python | 📅 2026-07-30 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,314 | 🐛 74 | 🌐 Python | 📅 2026-08-12 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [Pifpaf](https://github.com/jd/pifpaf) ⭐ 205 | 🐛 16 | 🌐 Python | 📅 2026-08-03 - A suite of fixtures and a command-line tool that allows to start and stop daemons for a quick throw-away usage. This is typically useful when needing these daemons to run integration testing.
...
* [logot](https://github.com/etianen/logot) ⭐ 126 | 🐛 12 | 🌐 Python | 📅 2026-06-22 - Test whether your code is logging correctly.
...
* [pytestify](https://github.com/dannysepler/pytestify) ⭐ 59 | 🐛 10 | 🌐 Python | 📅 2026-08-10 - Automatically convert unittests to pytest.
...
* [secure-log2test](https://github.com/golikovichev/secure-log2test) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - A CLI tool that converts Kibana JSON log exports into runnable pytest regression suites, with Pydantic-based redaction of authorization headers and other secrets at parse time.
...
* [quick-gate-python](https://github.com/hermes-labs-ai/quick-gate-python) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-11 - A deterministic CI quality gate that normalizes Ruff, Pyright, and pytest results into one fail-fast decision, attempts bounded auto-repair, and escalates with machine-readable evidence when it can't finish safely. PyPI: `pygate-ci`.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,923 | 🐛 13 | 🌐 Python | 📅 2026-08-13 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,658 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
* [helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,326 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - is great for web automation. Helium makes it easier to use.
* [splinter](https://github.com/cobrateam/splinter) ⭐ 2,751 | 🐛 58 | 🌐 Python | 📅 2025-08-16 - Open source tool for testing web applications.
...
* [pomcorn](https://github.com/saritasa-nest/pomcorn) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-07 - is an open source Python package that contains base classes to create systems based on Selenium framework and Page Object Model pattern
* [HMNextAuto](https://github.com/ziguiway/hmnextauto) ⭐ 16 | 🐛 3 | 🌐 Python | 📅 2026-05-06 - Python-based UI automation framework for HarmonyOS NEXT. API compatible with uiautomator2, supports XPath, image recognition, performance monitoring and notification management.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 313,783 | 🐛 26 | 🌐 Python | 📅 2026-08-05 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,129 | 🐛 124 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
* [Awesome PyTest](https://github.com/augustogoulart/awesome-pytest) ⭐ 573 | 🐛 2 | 📅 2026-06-24 - Focused on pytest.
* [Awesome Mutation testing](https://github.com/theofidry/awesome-mutation-testing) ⭐ 467 | 🐛 2 | 📅 2026-08-06 - Mutation testing resources: how to make better code by introducing bugs
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 70 | 🐛 3 | 🌐 Python | 📅 2026-08-13 - Check commit message formatting, branch naming, commit author, email, and more.
