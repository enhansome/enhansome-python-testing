...
* [behave](https://github.com/behave/behave) ⭐ 3,520 | 🐛 78 | 🌐 Python | 📅 2026-08-25 - is behavior-driven development, Python style.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,406 | 🐛 306 | 🌐 Python | 📅 2026-08-25 - is a tool for measuring code coverage of Python programs.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,627 | 🐛 61 | 🌐 Python | 📅 2026-08-25 - allows you to easily mock out tests based on AWS infrastructure.
...
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 12 | 🌐 Python | 📅 2026-08-25 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,403 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [fsociety](https://github.com/fsociety-team/fsociety) ⭐ 1,819 | 🐛 21 | 🌐 Python | 📅 2026-08-17 - A Modular Penetration Testing Framework.
* [fencer](https://github.com/abunuwas/fencer) ⭐ 90 | 🐛 4 | 🌐 Python | 📅 2024-08-02 - Fencer is an automated API security testing tool. It's an experimental project to see how much of the API security testing process can be automated.

## Property Based Testing

* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,912 | 🐛 48 | 🌐 Python | 📅 2026-08-25 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,560 | 🐛 9 | 🌐 Python | 📅 2026-08-25 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,153 | 🐛 20 | 🌐 Python | 📅 2026-08-25 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 43 | 🌐 Python | 📅 2026-08-21 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [VCR.py](https://github.com/kevin1024/vcrpy) ⭐ 2,981 | 🐛 161 | 🌐 Python | 📅 2026-08-25 - Record and replay HTTP interactions on your tests.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,319 | 🐛 2,161 | 🌐 Rust | 📅 2026-08-25 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,241 | 🐛 260 | 🌐 Python | 📅 2026-08-24 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,714 | 🐛 1,092 | 🌐 Python | 📅 2026-08-25 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,110 | 🐛 154 | 🌐 Rust | 📅 2026-08-20 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 802 | 🐛 11 | 🌐 Rust | 📅 2026-08-24 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,844 | 🐛 300 | 🌐 Python | 📅 2026-08-25 - A generic test automation framework.
...
* [Pynguin](https://github.com/se2p/pynguin) ⭐ 1,383 | 🐛 8 | 🌐 Python | 📅 2026-08-25 - A tool that allows developers to generate unit tests automatically.
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,317 | 🐛 76 | 🌐 Python | 📅 2026-08-19 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 875 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - A Node-based, open-source, self-improving QA agent that can exercise Python web applications externally through natural-language browser tests, persistent testing context, and self-healing tests.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 316,031 | 🐛 15 | 🌐 Python | 📅 2026-08-25 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,145 | 🐛 129 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
