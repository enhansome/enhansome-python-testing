...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,408 | 🐛 305 | 🌐 Python | 📅 2026-08-30 - is a tool for measuring code coverage of Python programs.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,634 | 🐛 61 | 🌐 Python | 📅 2026-08-28 - allows you to easily mock out tests based on AWS infrastructure.
...
* [pyfakefs](https://github.com/pytest-dev/pyfakefs) ⭐ 750 | 🐛 12 | 🌐 Python | 📅 2026-08-28 - A fake file system that mocks the Python file system modules.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,410 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - is a mutation testing system for Python, with a strong focus on ease of use.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,921 | 🐛 44 | 🌐 Python | 📅 2026-08-30 - is an advanced Quickcheck style property based testing library.
* [Atheris](https://github.com/google/atheris) ⭐ 1,668 | 🐛 40 | 🌐 Python | 📅 2026-06-17 - is a coverage-guided Python fuzzing engine. It supports fuzzing of Python code, but also native extensions written for CPython.
...
* [pytest-html-plus](https://github.com/reporterplus/pytest-html-plus) ⭐ 72 | 🐛 4 | 🌐 Python | 📅 2026-08-30 - Get a self-contained, actionable, easy-to-read single page HTML unified reports summarizing all your test results. Detect flaky tests.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,569 | 🐛 9 | 🌐 Python | 📅 2026-08-30 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [Tavern](https://github.com/taverntesting/tavern) ⭐ 1,154 | 🐛 25 | 🌐 Python | 📅 2026-08-30 - is a pytest plugin, command-line tool and Python library for automated testing of APIs, with a simple, concise and flexible YAML-based syntax.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 472 | 🐛 45 | 🌐 Python | 📅 2026-08-27 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 879 | 🐛 7 | 🌐 Python | 📅 2026-08-30 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,398 | 🐛 2,160 | 🌐 Rust | 📅 2026-08-30 - An extremely fast Python linter, written in Rust.
...
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,721 | 🐛 1,080 | 🌐 Python | 📅 2026-08-30 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 821 | 🐛 9 | 🌐 Rust | 📅 2026-08-30 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [slotscheck](https://github.com/ariebovenberg/slotscheck) ⭐ 127 | 🐛 13 | 🌐 Python | 📅 2026-08-25 - Find mistakes in your `__slots__` definitions.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,849 | 🐛 301 | 🌐 Python | 📅 2026-08-30 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,545 | 🐛 188 | 🌐 Python | 📅 2026-08-10 - A pytest plugin for Django applications.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,319 | 🐛 76 | 🌐 Python | 📅 2026-08-19 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,972 | 🐛 15 | 🌐 Python | 📅 2026-08-30 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,671 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 317,183 | 🐛 17 | 🌐 Python | 📅 2026-08-25 - A curated list of awesome Python frameworks, libraries, software and resources.
