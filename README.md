...
* [dirty-equals](https://github.com/samuelcolvin/dirty-equals) ⭐ 1,004 | 🐛 24 | 🌐 Python | 📅 2026-08-10 - A python library that (mis)uses the `__eq__` method to make python code (generally unit tests) more declarative and therefore easier to read and write.
...
* [Coverage.py](https://github.com/nedbat/coveragepy) ⭐ 3,409 | 🐛 309 | 🌐 Python | 📅 2026-08-16 - is a tool for measuring code coverage of Python programs.
* [diff\_cover](https://github.com/Bachmann1234/diff_cover) ⭐ 842 | 🐛 61 | 🌐 Python | 📅 2026-08-16 - Automatically find diff lines that need test coverage.
...
* [pytest-mysql](https://github.com/ClearcodeHQ/pytest-mysql) ⭐ 58 | 🐛 18 | 🌐 Python | 📅 2026-08-12 - A pytest plugin, that enables you to test your code that relies on a running MySQL Database. It allows you to specify fixtures for MySQL process and client.
* [pytest-rabbitmq](https://github.com/ClearcodeHQ/pytest-rabbitmq) ⭐ 51 | 🐛 18 | 🌐 Python | 📅 2026-08-10 - A pytest plugin, that enables you to test your code that relies on a running RabbitMQ server. It allows you to specify fixtures for RabbitMQ server and client.
...
* [moto](https://github.com/spulec/moto) ⭐ 8,614 | 🐛 60 | 🌐 Python | 📅 2026-08-15 - allows you to easily mock out tests based on AWS infrastructure.
...
* [httpretty](https://github.com/gabrielfalcao/HTTPretty) ⭐ 2,158 | 🐛 130 | 🌐 Python | 📅 2024-06-09 - HTTP request mock tool for Python.
...
* [Mutmut](https://github.com/boxed/mutmut) ⭐ 1,392 | 🐛 48 | 🌐 Python | 📅 2026-08-09 - is a mutation testing system for Python, with a strong focus on ease of use.
* [Cosmic Ray](https://github.com/sixty-north/cosmic-ray) ⭐ 649 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - makes small changes to your source code, running your test suite for each one.
...
* [polyfactory](https://github.com/litestar-org/polyfactory) ⭐ 1,501 | 🐛 73 | 🌐 Python | 📅 2026-08-16 - A simple and powerful mock data generation library, based around type hints and supporting dataclasses, typed-dicts, pydantic models, msgspec structs and more.
* [Model Bakery](https://github.com/model-bakers/model_bakery) ⭐ 1,002 | 🐛 13 | 🌐 Python | 📅 2026-08-15 - offers you a smart way to create fixtures for testing in Django.
...
* [Hypothesis](https://github.com/HypothesisWorks/hypothesis) ⭐ 8,888 | 🐛 46 | 🌐 Python | 📅 2026-08-16 - is an advanced Quickcheck style property based testing library.
...
* [Schemathesis](https://github.com/kiwicom/schemathesis) ⭐ 3,529 | 🐛 10 | 🌐 Python | 📅 2026-08-16 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
...
* [hypothesis-graphql](https://github.com/Stranger6667/hypothesis-graphql) ⭐ 48 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - Hypothesis strategies for GraphQL schemas, queries and data.
...
* [pytest-rerunfailures](https://github.com/pytest-dev/pytest-rerunfailures) ⭐ 471 | 🐛 45 | 🌐 Python | 📅 2026-08-14 - A pytest plugin that re-runs failed tests up to -n times to eliminate flakey failures.
...
* [syrupy](https://github.com/tophat/syrupy) ⭐ 872 | 🐛 19 | 🌐 Python | 📅 2026-08-16 - is a zero-dependency pytest snapshot plugin. It enables developers to write tests which assert immutability of computed results.
...
* [ApprovalTests](https://github.com/approvals/ApprovalTests.Python) ⭐ 209 | 🐛 14 | 🌐 Python | 📅 2026-08-16 - work by comparing the test results to a golden master.
...
* [ruff](https://github.com/charliermarsh/ruff) ⭐ 49,226 | 🐛 2,102 | 🌐 Rust | 📅 2026-08-16 - An extremely fast Python linter, written in Rust.
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,220 | 🐛 260 | 🌐 Python | 📅 2026-08-04 - is a tool designed to find common security issues in Python code.
* [Pylint](https://github.com/PyCQA/pylint) ⭐ 5,713 | 🐛 1,084 | 🌐 Python | 📅 2026-08-16 - A Python static code analysis tool which looks for programming errors, helps enforcing a coding standard, sniffs for code smells and offers simple refactoring suggestions.
* [typos](https://github.com/crate-ci/typos) ⭐ 4,090 | 🐛 153 | 🌐 Rust | 📅 2026-08-07 - A Source code spell checker that finds and corrects spelling mistakes in source code.
...
* [complexipy](https://github.com/rohaquinlop/complexipy) ⭐ 777 | 🐛 10 | 🌐 Python | 📅 2026-08-12 - An extremely fast Python library to calculate the cognitive complexity of Python files, written in Rust.
...
* [Robot Framework](https://github.com/robotframework/robotframework) ⭐ 11,822 | 🐛 302 | 🌐 Python | 📅 2026-08-16 - A generic test automation framework.
* [pytest-django](https://github.com/pytest-dev/pytest-django) ⭐ 1,543 | 🐛 187 | 🌐 Python | 📅 2026-08-10 - A pytest plugin for Django applications.
...
* [CrossHair](https://github.com/pschanely/CrossHair) ⭐ 1,315 | 🐛 74 | 🌐 Python | 📅 2026-08-16 - An analysis tool for Python that blurs the line between testing and type systems.
...
* [SeleniumBase](https://github.com/seleniumbase/SeleniumBase) ⭐ 12,929 | 🐛 13 | 🌐 Python | 📅 2026-08-14 - is an all-in-one Python framework for automated browser testing. Tests are run with "pytest", and use WebDriver APIs for web-page interaction.
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,663 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - is a cross-platform GUI automation Python module for human beings.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md#testing) ⭐ 314,298 | 🐛 16 | 🌐 Python | 📅 2026-08-16 - A curated list of awesome Python frameworks, libraries, software and resources.
* [Python test automation](https://github.com/atinfo/awesome-test-automation/blob/master/python-test-automation.md) ⭐ 7,132 | 🐛 127 | 📅 2025-11-28 - A comprehensive curated list of python test automation frameworks, tools, libraries and software to help software engineers easily bootstrap test automation on python.
...
* [commit-check](https://github.com/commit-check/commit-check) ⭐ 70 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - Check commit message formatting, branch naming, commit author, email, and more.
